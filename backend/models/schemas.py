...
class LoopConfig(BaseModel):
    ...
    max_iterations: Optional[int] = 0  # None or 0 means unlimited
...
# ============================================================================
# Apigee-Compatible Error Response Models
# ============================================================================

class ErrorDetail(BaseModel):
    """Error detail for standardized error responses (Apigee-compatible)"""
    code: str
    message: str
