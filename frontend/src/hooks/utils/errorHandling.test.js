 ...
 */ import { extractErrorMessage, handleApiError, handleError, createSafeErrorHandler } from './errorHandling';
...
describe('errorHandling', ()=>{
    ...
    describe('extractErrorMessage', ()=>{
        ...
        it('should handle case where logicalOr returns null and use defaultMessage', ()=>{
            ...
            const error = new Error('');
            const result = extractErrorMessage(error, null);
        ...
        it('should handle case where logicalOr returns undefined - uses default parameter', ()=>{
            ...
            const error = new Error('');
            const result = extractErrorMessage(error, undefined);
