...
describe('useDebounce', ()=>{
    ...
    it('should cancel previous timeout when value changes', ()=>{
        const callback = jest.fn();
        const { rerender } = renderHook(({ value })=>useDebounce(value, 100, callback), {
            initialProps: {
                value: 'value1'
            }
        });
    ...
    it('should handle delay change', ()=>{
        const callback = jest.fn();
        const { rerender } = renderHook(({ delay })=>useDebounce('test', delay, callback), {
            initialProps: {
                delay: 100
            }
        });
    ...
    it('should handle callback change', ()=>{
        ...
        const { rerender } = renderHook(({ callback })=>useDebounce('test', 100, callback), {
            initialProps: {
                callback: callback1
            }
        });
