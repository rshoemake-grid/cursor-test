 ...
 */ export function buildJsonHeaders(additionalHeaders = {}) {
    return buildHeaders({
        contentType: 'application/json',
        additionalHeaders
    });
 ...
 */ export function buildUploadHeaders(additionalHeaders = {}) {
    return buildHeaders({
        contentType: null,
        additionalHeaders
    });
 ...
 */ export function extractApiErrorMessage(error, defaultMessage = 'An error occurred') {
 ...
 */ export function isApiResponseOk(response) {
