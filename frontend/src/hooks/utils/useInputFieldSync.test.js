...
import { useInputFieldSync, useInputFieldSyncSimple } from './useInputFieldSync';
describe('useInputFieldSync', ()=>{
    describe('useInputFieldSync', ()=>{
        it('should initialize with default value', ()=>{
            ...
            const { result } = renderHook(()=>useInputFieldSync(ref, null, 'default'));
        ...
        it('should update when configValue changes and field is not active', ()=>{
            ...
            const { result, rerender } = renderHook(({ configValue })=>useInputFieldSync(ref, configValue, 'default'), {
                initialProps: {
                    configValue: null
                }
            });
        ...
        it('should not treat empty string as default for non-string types', ()=>{
            ...
            const { result, rerender } = renderHook(({ configValue })=>useInputFieldSync(ref, configValue, 0), {
                initialProps: {
                    configValue: 5
                }
            });
        ...
        it('should allow manual value updates via setValue', ()=>{
            ...
            const { result } = renderHook(()=>useInputFieldSync(ref, 'config', 'default'));
        ...
        it('should handle boolean values', ()=>{
            ...
            const { result, rerender } = renderHook(({ configValue })=>useInputFieldSync(ref, configValue, false), {
                initialProps: {
                    configValue: true
                }
            });
    ...
    describe('useInputFieldSyncSimple', ()=>{
        it('should initialize with default value', ()=>{
            const { result } = renderHook(()=>useInputFieldSyncSimple(null, 'default'));
            expect(result.current[0]).toBe('default');
        });
        it('should update when configValue changes', ()=>{
            const { result, rerender } = renderHook(({ configValue })=>useInputFieldSyncSimple(configValue, 'default'), {
                initialProps: {
                    configValue: null
                }
            });
        ...
        it('should allow manual value updates via setValue', ()=>{
            const { result } = renderHook(()=>useInputFieldSyncSimple('config', 'default'));
            expect(result.current[0]).toBe('config');
            act(()=>{
                result.current[1]('manual-update');
            });
        ...
        it('should handle number values', ()=>{
            const { result, rerender } = renderHook(({ configValue })=>useInputFieldSyncSimple(configValue, 0), {
                initialProps: {
                    configValue: 42
                }
            });
        ...
        it('should handle boolean values', ()=>{
            const { result, rerender } = renderHook(({ configValue })=>useInputFieldSyncSimple(configValue, false), {
                initialProps: {
                    configValue: true
                }
            });
