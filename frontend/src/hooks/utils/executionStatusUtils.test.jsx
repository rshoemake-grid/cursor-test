...
describe("ExecutionStatusChecker", () => {
  describe("isTerminated", () => {
    ...
    it("should use lastKnownStatus when status is undefined", () => {
      expect(ExecutionStatusChecker.isTerminated(void 0, EXECUTION_STATUS.COMPLETED)).toBe(true);
      expect(ExecutionStatusChecker.isTerminated(void 0, EXECUTION_STATUS.FAILED)).toBe(true);
      expect(ExecutionStatusChecker.isTerminated(void 0, EXECUTION_STATUS.RUNNING)).toBe(false);
    });
  ...
  describe("shouldSkip", () => {
    ...
    it("should check lastKnownStatus when status is undefined", () => {
      expect(ExecutionStatusChecker.shouldSkip("exec-123", void 0, EXECUTION_STATUS.COMPLETED)).toBe(true);
      expect(ExecutionStatusChecker.shouldSkip("exec-123", void 0, EXECUTION_STATUS.RUNNING)).toBe(false);
    });
  });
...
describe("Legacy function exports", () => {
  describe("isExecutionTerminated", () => {
    it("should delegate to ExecutionStatusChecker.isTerminated", () => {
      ...
      expect(isExecutionTerminated(void 0, EXECUTION_STATUS.COMPLETED)).toBe(true);
    });
  });
