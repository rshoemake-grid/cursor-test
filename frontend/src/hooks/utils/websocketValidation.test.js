 ...
 */ import { isValidWebSocket, hasPendingReconnection, sanitizeReconnectionDelay, isCleanClosure, getCloseReason } from './websocketValidation';
...
describe('websocketValidation', ()=>{
    describe('isValidWebSocket', ()=>{
        ...
        it('should return false for undefined (cast as null)', ()=>{
            expect(isValidWebSocket(undefined)).toBe(false);
        });
    ...
    describe('hasPendingReconnection', ()=>{
        ...
        it('should return false for undefined (cast as null)', ()=>{
            expect(hasPendingReconnection(undefined)).toBe(false);
        });
