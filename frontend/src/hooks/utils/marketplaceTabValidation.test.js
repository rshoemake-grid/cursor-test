 ...
 */ import { isRepositoryTab, isWorkflowsOfWorkflowsTab, isAgentsTab, isWorkflowsSubTab, isAgentsSubTab, shouldLoadTemplates, shouldLoadRepositoryAgents, shouldLoadWorkflowsOfWorkflows, shouldLoadAgents, calculateLoadingState } from './marketplaceTabValidation';
describe('marketplaceTabValidation', ()=>{
    ...
    describe('calculateLoadingState', ()=>{
        it('should return templates loading when repository/workflows', ()=>{
            expect(calculateLoadingState('repository', 'workflows', true, false, false, false)).toBe(true);
            expect(calculateLoadingState('repository', 'workflows', false, false, false, false)).toBe(false);
        });
        it('should return repository agents loading when repository/agents', ()=>{
            expect(calculateLoadingState('repository', 'agents', false, true, false, false)).toBe(true);
            expect(calculateLoadingState('repository', 'agents', false, false, false, false)).toBe(false);
        });
        it('should return workflows-of-workflows loading when workflows-of-workflows tab', ()=>{
            expect(calculateLoadingState('workflows-of-workflows', 'workflows', false, false, true, false)).toBe(true);
            expect(calculateLoadingState('workflows-of-workflows', 'workflows', false, false, false, false)).toBe(false);
        });
        it('should return agents loading when agents tab', ()=>{
            expect(calculateLoadingState('agents', 'workflows', false, false, false, true)).toBe(true);
            expect(calculateLoadingState('agents', 'workflows', false, false, false, false)).toBe(false);
        });
