 ...
 */ export function getMaxNodeX(nodes) {
    if (nodes.length === 0) {
        return 0;
    }
 ...
 */ export function getMaxNodeY(nodes) {
    if (nodes.length === 0) {
        return 0;
    }
 ...
 */ export function calculateNextNodePosition(existingNodes, options = {}) {
 ...
 */ export function calculateMultipleNodePositions(existingNodes, count, options = {}) {
    const opts = mergeOptions(options);
 ...
 * @param options Positioning options
 * @returns Array of positions for the new nodes
 */ export function calculateGridPosition(existingNodes, count, columnsPerRow = 3, options = {}) {
    const opts = mergeOptions(options);
 ...
 */ export function calculateRelativePosition(referenceNode, offset = {
    x: 200,
    y: 0
}) {
    return {
