 ...
 */ import { validateRequest, buildRequestHeaders, executeAuthenticatedRequest, HTTP_CLIENT_ERROR_MSG, URL_EMPTY_ERROR_MSG } from './authenticatedRequestHandler';
describe('authenticatedRequestHandler', ()=>{
    ...
    describe('executeAuthenticatedRequest', ()=>{
        ...
        it('should execute GET request successfully', async ()=>{
            ...
            expect(mockClient.get).toHaveBeenCalledWith('https://api.example.com/test', expect.objectContaining({
        ...
        it('should execute POST request successfully', async ()=>{
            ...
            expect(mockClient.post).toHaveBeenCalledWith('https://api.example.com/test', {
                key: 'value'
        ...
        it('should execute PUT request successfully', async ()=>{
            ...
            expect(mockClient.put).toHaveBeenCalledWith('https://api.example.com/test', {
                key: 'value'
            }, expect.objectContaining({
                Authorization: 'Bearer test-token',
                'Content-Type': 'application/json'
        ...
        it('should execute DELETE request successfully', async ()=>{
            ...
            expect(mockClient.delete).toHaveBeenCalledWith('https://api.example.com/test', expect.objectContaining({
                Authorization: 'Bearer test-token'
            }));
        });
        it('should reject with HttpClientError when client is invalid', async ()=>{
            ...
            await expect(executeAuthenticatedRequest(config, invalidContext)).rejects.toMatchObject({
        ...
        it('should reject with UnsupportedMethodError for unsupported method', async ()=>{
            ...
            await expect(executeAuthenticatedRequest(config, contextWithPatch)).rejects.toMatchObject({
        ...
        it('should handle synchronous errors from request function', async ()=>{
            ...
            await expect(executeAuthenticatedRequest(config, context)).rejects.toBe(syncError);
        });
        it('should handle promise rejection from request function', async ()=>{
            ...
            await expect(executeAuthenticatedRequest(config, context)).rejects.toBe(asyncError);
        });
