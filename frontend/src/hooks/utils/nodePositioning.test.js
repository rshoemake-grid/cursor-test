import { getMaxNodeX, getMaxNodeY, calculateNextNodePosition, calculateMultipleNodePositions, calculateGridPosition, calculateRelativePosition } from './nodePositioning';
describe('nodePositioning', ()=>{
    ...
    describe('mergeOptions edge cases', ()=>{
        ...
        it('should handle undefined options', ()=>{
            const position = calculateNextNodePosition([], undefined);
            expect(position).toEqual({
                x: 250,
                y: 250
            }); // All defaults
