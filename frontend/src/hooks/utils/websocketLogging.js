 ...
 */ export function logSkipConnectionReason(executionId, executionStatus, lastKnownStatus, logger) {
 ...
 * Mutation-resistant: uses constants for status comparisons
 */ export function logSkipReconnectReason(executionId, executionStatus, lastKnownStatus, event, isCleanClosure, logger) {
    if (isTemporaryExecutionId(executionId)) {
