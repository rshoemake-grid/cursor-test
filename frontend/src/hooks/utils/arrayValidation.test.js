 ...
 */ import { isValidArray, hasArrayItems, isArrayEmpty, getArrayLength, canProcessArray } from './arrayValidation';
describe('arrayValidation', ()=>{
    ...
    describe('hasArrayItems', ()=>{
        ...
        it('should return false when not an array', ()=>{
            expect(hasArrayItems('not array')).toBe(false);
        });
    });
    describe('isArrayEmpty', ()=>{
        ...
        it('should return true when not an array', ()=>{
            expect(isArrayEmpty('not array')).toBe(true);
        });
    });
    describe('getArrayLength', ()=>{
        it('should return length when array has items', ()=>{
            expect(getArrayLength([
                1,
                2,
                3
            ])).toBe(3);
        ...
        it('should return 0 when not an array', ()=>{
            expect(getArrayLength('not array')).toBe(0);
        });
    });
    describe('canProcessArray', ()=>{
        it('should return true when array has items', ()=>{
            expect(canProcessArray([
                1,
                2,
                3
            ])).toBe(true);
