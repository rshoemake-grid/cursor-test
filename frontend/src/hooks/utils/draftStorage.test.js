 ...
 */ import { loadDraftsFromStorage, saveDraftsToStorage, getDraftForTab, saveDraftForTab, deleteDraftForTab, clearAllDrafts, draftExists } from './draftStorage';
...
describe('draftStorage', ()=>{
    ...
    describe('saveDraftsToStorage', ()=>{
        ...
        it('should pass options to setLocalStorageItem', ()=>{
            ...
            expect(mockSetLocalStorageItem).toHaveBeenCalledWith('workflowBuilderDrafts', mockDrafts, {
                storage: mockStorage,
                logger: mockLogger
            });
        });
    ...
    describe('saveDraftForTab', ()=>{
        ...
        it('should pass options to storage functions', ()=>{
            ...
            mockGetLocalStorageItem.mockReturnValue({});
            saveDraftForTab('tab-1', mockDraft, {
                storage: mockStorage
            });
            expect(mockGetLocalStorageItem).toHaveBeenCalled();
