...
describe("providerValidation", () => {
  describe("isProviderValid", () => {
    ...
    it("should return false for undefined", () => {
      expect(isProviderValid(void 0)).toBe(false);
    });
  });
  describe("isProviderEnabled", () => {
    ...
    it("should return false for undefined provider", () => {
      expect(isProviderEnabled(void 0)).toBe(false);
    });
  });
  ...
  describe("isValidProvidersArray", () => {
    ...
    it("should return false for undefined", () => {
      expect(isValidProvidersArray(void 0)).toBe(false);
    });
    it("should return false for string", () => {
      expect(isValidProvidersArray("not array")).toBe(false);
    });
    it("should return false for object", () => {
      expect(isValidProvidersArray({})).toBe(false);
    });
  });
  describe("isValidData", () => {
    ...
    it("should return false for undefined", () => {
      expect(isValidData(void 0)).toBe(false);
    });
  });
  describe("hasProviders", () => {
    ...
    it("should return false when undefined", () => {
      expect(hasProviders(void 0)).toBe(false);
    });
    it("should return false when not an array", () => {
      expect(hasProviders("not array")).toBe(false);
    });
  });
});
