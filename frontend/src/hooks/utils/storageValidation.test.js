 ...
 */ import { isStorageAvailable, canSaveToStorage, getStorageItem, setStorageItem } from './storageValidation';
describe('storageValidation', ()=>{
    ...
    describe('setStorageItem', ()=>{
        it('should set item when storage available', ()=>{
            const result = setStorageItem(mockStorage, 'test-key', {
                key: 'value'
            });
        ...
        it('should return false when storage is null', ()=>{
            const result = setStorageItem(null, 'test-key', {
                key: 'value'
            });
