 ...
 */ import { isValidUser, canUserOperate, canMigrateUserData, doesUserOwnItem, canUserDeleteItem, getUserId, getUserDisplayName } from './userValidation';
describe('userValidation', ()=>{
    ...
    describe('canMigrateUserData', ()=>{
        ...
        it('should return false when data is not an array', ()=>{
            ...
            expect(canMigrateUserData(user, 'not array')).toBe(false);
        });
    });
