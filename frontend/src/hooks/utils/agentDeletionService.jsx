...
function deleteAgentsFromStorage(storage, storageKey, agentIdsToDelete, callbacks) {
  ...
  try {
    ...
    const hasErrorPrefix = hasCallbacks === true && callbacks.errorPrefix !== null && callbacks.errorPrefix !== void 0;
...
function extractAgentIds(agents) {
  ...
  return new Set(
    agents.map((a) => a && a.id ? a.id : null).filter((id) => id !== null && id !== void 0)
  );
}
