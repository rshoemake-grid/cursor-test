...
describe('ExecutionStateManager', ()=>{
    ...
    describe('handleExecutionLogUpdate', ()=>{
        ...
        it('should not modify other executions', ()=>{
            ...
            const result = manager.handleExecutionLogUpdate(tabs, 'workflow-1', 'exec-1', {
                message: 'Log'
            });
            expect(result[0].executions[0].logs).toHaveLength(1);
        ...
        it('should return empty array when workflow not found', ()=>{
            ...
            const result = manager.handleExecutionLogUpdate(tabs, 'non-existent-workflow', 'exec-1', {
                message: 'Log'
            });
    ...
    describe('handleExecutionNodeUpdate', ()=>{
        ...
        it('should preserve existing node states', ()=>{
            ...
            const result = manager.handleExecutionNodeUpdate(tabs, 'workflow-1', 'exec-1', 'node-2', {
                status: 'new'
            });
        ...
        it('should return empty array when workflow not found', ()=>{
            ...
            const result = manager.handleExecutionNodeUpdate(tabs, 'non-existent-workflow', 'exec-1', 'node-1', {
                status: 'new'
            });
            expect(result[0].executions).toEqual([]);
        });
        it('should not modify executions that do not match executionId', ()=>{
            ...
            const result = manager.handleExecutionNodeUpdate(tabs, 'workflow-1', 'exec-1', 'node-1', {
                status: 'new'
            });
            expect(result[0].executions[0].nodes['node-1']).toEqual({
                status: 'new'
