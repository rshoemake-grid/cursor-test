 ...
 */ import { createNewTab, createTabWithWorkflow, updateTab, updateTabByWorkflowId, findTab, findTabByWorkflowId, removeTab, handleActiveTabAfterClose, tabExists, getTabIndex } from './tabUtils';
describe('tabUtils', ()=>{
    const mockTabs = [
        {
            id: 'tab-1',
    ...
    describe('updateTab', ()=>{
        it('should update a tab by ID', ()=>{
            const updated = updateTab(mockTabs, 'tab-1', {
                name: 'Updated Name'
            });
        ...
        it('should return original array if tab not found', ()=>{
            const updated = updateTab(mockTabs, 'non-existent', {
                name: 'Test'
            });
    ...
    describe('findTabByWorkflowId', ()=>{
        ...
        it('should return undefined for null workflow ID', ()=>{
            const tab = findTabByWorkflowId(mockTabs, 'null');
            expect(tab).toBeUndefined();
        });
    });
    describe('removeTab', ()=>{
