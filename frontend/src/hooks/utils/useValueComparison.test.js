 ...
 */ import { defaultComparisonStrategy, hasValueChanged } from './useValueComparison';
describe('defaultComparisonStrategy', ()=>{
    ...
    it('should handle empty objects', ()=>{
        ...
        expect(defaultComparisonStrategy({}, {
            a: 1
        })).toBe(true);
    });
...
describe('hasValueChanged', ()=>{
    ...
    it('should use custom strategy when provided', ()=>{
        const customStrategy = jest.fn((a, b)=>a.length !== b.length);
    ...
    it('should handle custom strategy for reference equality', ()=>{
        const referenceEqualStrategy = (a, b)=>a !== b;
        const obj1 = {
            a: 1
        };
        const obj2 = {
