 ...
 */ export function isPendingExecutionId(executionId) {
 ...
 */ export function isTemporaryExecutionId(executionId) {
    return isPendingExecutionId(executionId);
}
/**
 * Check if execution ID is real (not pending)
 * Mutation-resistant: explicit prefix check
 */ export function isRealExecutionId(executionId) {
 ...
 */ export function isValidExecutionId(executionId) {
 ...
 */ export function executionIdStartsWith(executionId, prefix) {
    if (!isValidExecutionId(executionId)) {
        return false;
    }
 ...
 */ export function shouldLogExecutionError(exec) {
    if (exec == null) {
        return false;
    }
    if (exec.id == null) {
