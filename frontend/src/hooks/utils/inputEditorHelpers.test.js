 ...
 */ import { createTextInputHandler, createSelectHandler, createCheckboxHandler } from './inputEditorHelpers';
describe('inputEditorHelpers', ()=>{
    describe('createTextInputHandler', ()=>{
        it('should create handler that updates value and calls onConfigUpdate', ()=>{
            ...
            const field = 'name';
            const handler = createTextInputHandler(setValue, onConfigUpdate, configField, field);
            const event = {
                target: {
                    value: 'test-value'
                }
        ...
        it('should handle empty string value', ()=>{
            const setValue = jest.fn();
            const onConfigUpdate = jest.fn();
            const handler = createTextInputHandler(setValue, onConfigUpdate, 'input_config', 'name');
            const event = {
                target: {
                    value: ''
                }
        ...
        it('should handle textarea elements', ()=>{
            const setValue = jest.fn();
            const onConfigUpdate = jest.fn();
            const handler = createTextInputHandler(setValue, onConfigUpdate, 'input_config', 'description');
            const event = {
                target: {
        ...
        it('should use correct configField and field parameters', ()=>{
            const setValue = jest.fn();
            const onConfigUpdate = jest.fn();
            const handler = createTextInputHandler(setValue, onConfigUpdate, 'custom_config', 'custom_field');
            const event = {
                target: {
                    value: 'value'
                }
    ...
    describe('createSelectHandler', ()=>{
        it('should create handler that updates value and calls onConfigUpdate', ()=>{
            ...
            const configField = 'input_config';
            const field = 'region';
            const handler = createSelectHandler(setValue, onConfigUpdate, configField, field);
            const event = {
                target: {
                    value: 'us-west-1'
                }
        ...
        it('should handle empty string value', ()=>{
            const setValue = jest.fn();
            const onConfigUpdate = jest.fn();
            const handler = createSelectHandler(setValue, onConfigUpdate, 'input_config', 'region');
            const event = {
                target: {
                    value: ''
                }
        ...
        it('should use correct configField and field parameters', ()=>{
            const setValue = jest.fn();
            const onConfigUpdate = jest.fn();
            const handler = createSelectHandler(setValue, onConfigUpdate, 'custom_config', 'custom_field');
            const event = {
                target: {
                    value: 'option1'
                }
    ...
    describe('createCheckboxHandler', ()=>{
        it('should create handler that updates value and calls onConfigUpdate', ()=>{
            ...
            const handler = createCheckboxHandler(setValue, onConfigUpdate, configField, field);
            const event = {
                target: {
                    checked: true
                }
        ...
        it('should handle false checkbox value', ()=>{
            const setValue = jest.fn();
            const onConfigUpdate = jest.fn();
            const handler = createCheckboxHandler(setValue, onConfigUpdate, 'input_config', 'overwrite');
            const event = {
                target: {
                    checked: false
                }
        ...
        it('should use correct configField and field parameters', ()=>{
            const setValue = jest.fn();
            const onConfigUpdate = jest.fn();
            const handler = createCheckboxHandler(setValue, onConfigUpdate, 'custom_config', 'custom_field');
            const event = {
                target: {
                    checked: true
                }
