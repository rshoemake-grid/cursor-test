 ...
 */ import { updateDraftStorage, resetFlagAfterDelay } from './draftUpdateService';
...
describe('draftUpdateService', ()=>{
    ...
    describe('updateDraftStorage', ()=>{
        it('should update draft storage with new nodes', ()=>{
            ...
            updateDraftStorage(tabDraftsRef, tabId, updatedNodes, workflowId, workflowName, workflowDescription, tabIsUnsaved, saveDraftsToStorage, logger);
        ...
        it('should preserve existing edges when updating', ()=>{
            ...
            updateDraftStorage(tabDraftsRef, tabId, updatedNodes, null, '', '', false, saveDraftsToStorage, logger);
            jest.advanceTimersByTime(DRAFT_UPDATE.IMMEDIATE_DELAY);
            const draft = tabDraftsRef.current[tabId];
