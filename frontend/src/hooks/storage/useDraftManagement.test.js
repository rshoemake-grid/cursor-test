...
describe('useDraftManagement', ()=>{
    ...
    it('should save draft when workflow state changes', ()=>{
        ...
        expect(mockSetLocalStorageItem).toHaveBeenCalledWith('workflowBuilderDrafts', expect.objectContaining({
