 ...
 */ export function useNodeForm({ selectedNode, onUpdate }) {
    ...
    useEffect(()=>{
        ...
        const nodeName = logicalOr(typeof nodeData.name === 'string' ? nodeData.name : '', logicalOr(typeof nodeData.label === 'string' ? nodeData.label : '', ''));
