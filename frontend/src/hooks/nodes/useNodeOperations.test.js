...
describe('useNodeOperations', ()=>{
    ...
    describe('handleDelete', ()=>{
        it('should delete node after confirmation', async ()=>{
            ...
            expect(mockShowConfirm).toHaveBeenCalledWith(expect.stringContaining('Test Node'), {
                title: 'Delete Node',
                confirmText: 'Delete',
                cancelText: 'Cancel',
                type: 'danger'
        ...
        it('should use label if name is not available', async ()=>{
            ...
            expect(mockShowConfirm).toHaveBeenCalledWith(expect.stringContaining('Node Label'), expect.any(Object));
        });
    ...
    describe('handleUpdateInput', ()=>{
        it('should expand array when index is beyond current length (while loop coverage)', ()=>{
            ...
            expect(updatedNode.data.inputs[5]).toEqual({
                source_node: 'node6'
            });
