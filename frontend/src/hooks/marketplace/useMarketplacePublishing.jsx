...
function useMarketplacePublishing({
  ...
  const handlePublish = useCallback(async (event) => {
    ...
    if (activeTab === null || activeTab === void 0 || activeTab.workflowId === null || activeTab.workflowId === void 0 || activeTab.workflowId === "") {
    ...
    try {
      ...
      const headers = {
        ...
        ...token !== null && token !== void 0 && token !== "" ? { Authorization: `Bearer ${token}` } : {}
      };
