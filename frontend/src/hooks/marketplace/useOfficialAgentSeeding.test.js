...
describe('useOfficialAgentSeeding', ()=>{
    ...
    describe('storage null check', ()=>{
        it('should return early if storage is null', ()=>{
            renderHook(()=>useOfficialAgentSeeding({
                    storage: null,
    ...
    describe('seeded flag check', ()=>{
        ...
        it('should handle error when checking seeded flag', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockLogger.error).toHaveBeenCalledWith('Failed to check seeded key:', expect.any(Error));
            });
    ...
    describe('removeItem error handling', ()=>{
        it('should handle error when removing seeded key', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockLogger.error).toHaveBeenCalledWith('Failed to remove seeded key:', expect.any(Error));
            });
            // Should continue with seeding after error
            expect(mockHttpClient.get).toHaveBeenCalled();
        });
    ...
    describe('fetch templates', ()=>{
        it('should fetch templates and filter official workflows', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockHttpClient.get).toHaveBeenCalledWith('https://api.example.com/templates?sort_by=popular');
            });
        ...
        it('should handle fetch templates error - response not ok', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockLogger.error).toHaveBeenCalledWith('[Marketplace] Failed to fetch templates:', 'Not Found');
            });
        ...
        it('should handle fetch templates error - exception', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockLogger.error).toHaveBeenCalledWith('[Marketplace] Failed to seed official agents:', expect.any(Error));
            });
        });
    ...
    describe('workflow processing', ()=>{
        it('should process workflows and extract agent nodes', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockHttpClient.post).toHaveBeenCalledWith('https://api.example.com/templates/wf1/use', {}, {
        ...
        it('should handle workflow fetch error - response not ok', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockLogger.error).toHaveBeenCalledWith('[Marketplace] Failed to fetch workflow wf1: Not Found');
            });
        ...
        it('should handle workflow fetch error - exception', async ()=>{
            ...
            await waitFor(()=>{
                expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining('[Marketplace] Failed to fetch workflow'), expect.any(Error));
            });
        });
    ...
    describe('agent creation', ()=>{
        it('should create agent with all properties from workflow and node', async ()=>{
            ...
            expect(agent.agent_config).toEqual({
                model: 'gpt-4',
                temperature: 0.7
            });
