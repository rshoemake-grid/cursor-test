    ...
    it("should call toLowerCase() on name property", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          category: "",
          searchQuery: "test",
          // Should call a.name.toLowerCase()
          sortBy: "popular",
          user: null,
          activeTab: "agents",
          repositorySubTab: "agents"
    ...
    it("should call toLowerCase() on description property", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          // Should call a.description.toLowerCase()
          sortBy: "popular",
          user: null,
          activeTab: "agents",
          repositorySubTab: "agents"
    ...
    it("should call includes() on name.toLowerCase() result", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          category: "",
          searchQuery: "test",
          // Should call name.toLowerCase().includes('test')
          sortBy: "popular",
          user: null,
          activeTab: "agents",
          repositorySubTab: "agents"
    ...
    it("should call includes() on description.toLowerCase() result", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          category: "",
          searchQuery: "description",
          // Should call description.toLowerCase().includes('description')
          sortBy: "popular",
          user: null,
          activeTab: "agents",
          repositorySubTab: "agents"
    ...
    it("should call includes() on tag.toLowerCase() result", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          category: "",
          searchQuery: "test",
          // Should call tag.toLowerCase().includes('test')
          sortBy: "popular",
          user: null,
          activeTab: "agents",
          repositorySubTab: "agents"
