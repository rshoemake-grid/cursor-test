    ...
    it("should call tags.some() with tag.toLowerCase().includes() callback", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          category: "",
          searchQuery: "test",
          // Should call tags.some(tag => tag.toLowerCase().includes('test'))
          sortBy: "popular",
          user: null,
          activeTab: "agents",
    ...
    it("should call filter() with category comparison callback", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          apiBaseUrl: "http://api.test",
          category: "automation",
          // Should call filter(a => a.category === 'automation')
          searchQuery: "",
          sortBy: "popular",
          user: null,
          activeTab: "agents",
    ...
    it("should call filter() with search query callback", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          category: "",
          searchQuery: "Test",
          // Should call filter with search callback
          sortBy: "popular",
          user: null,
          activeTab: "agents",
          repositorySubTab: "agents"
    ...
    it("should call sort() with comparison callback", async () => {
      ...
      const { result } = renderHook(
        () => useMarketplaceData({
          ...
          searchQuery: "",
          sortBy: "popular",
          // Should call sort with comparison callback
          user: null,
          activeTab: "agents",
          repositorySubTab: "agents"
        })
