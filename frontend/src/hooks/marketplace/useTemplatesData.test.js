...
describe('useTemplatesData', ()=>{
    ...
    it('should return fetchTemplates function', ()=>{
        const { result } = renderHook(()=>useTemplatesData({
    ...
    it('should fetch templates successfully', async ()=>{
        ...
        expect(mockHttpClient.get).toHaveBeenCalledWith(expect.stringContaining('/templates'));
        ...
        expect(mockHttpClient.get).toHaveBeenCalledWith(expect.stringContaining('sort_by=popular'));
    ...
    it('should update fetch function when dependencies change', ()=>{
        const { result, rerender } = renderHook(({ category })=>useTemplatesData({
                httpClient: mockHttpClient,
                apiBaseUrl: 'http://api.test',
                category,
                searchQuery: '',
