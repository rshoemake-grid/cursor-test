...
describe('useWorkflowsOfWorkflowsData', ()=>{
    ...
    it('should return fetchWorkflowsOfWorkflows function', ()=>{
        const { result } = renderHook(()=>useWorkflowsOfWorkflowsData({
    ...
    it('should fetch and filter workflows of workflows', async ()=>{
        ...
        expect(mockHttpClient.post).toHaveBeenCalledWith(expect.stringContaining(`/templates/${mockTemplate.id}/use`), {}, {
