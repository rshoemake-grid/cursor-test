    ...
    it("should handle error in filter operation (description.toLowerCase throws)", async () => {
      const invalidData = [
        {
          id: "agent-1",
          name: "Other Name",
          // Doesn't match 'test', so evaluates description
          description: null,
          // Utility function handles this gracefully
          tags: [],
          category: "automation",
      ...
      const { result } = renderHook(() =>
        useMarketplaceData({
          ...
          category: "",
          searchQuery: "test",
          // Name doesn't match, so evaluates description
          sortBy: "popular",
          user: null,
          activeTab: "repository",
          repositorySubTab: "agents",
    ...
    it("should handle error in filter operation (tags.some throws)", async () => {
      ...
      const { result } = renderHook(() =>
        useMarketplaceData({
          ...
          category: "",
          searchQuery: "test",
          // Name and description don't match, so evaluates tags
          sortBy: "popular",
          user: null,
          activeTab: "repository",
          repositorySubTab: "agents",
