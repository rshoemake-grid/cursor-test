...
import { executeAuthenticatedRequest, HTTP_CLIENT_ERROR_MSG, URL_EMPTY_ERROR_MSG } from '../utils/authenticatedRequestHandler';
 ...
 */ export function useAuthenticatedApi(httpClient, apiBaseUrl) {
    ...
    try {
        ...
        client = clientResult !== null && clientResult !== undefined ? clientResult : defaultAdapters.createHttpClient();
    } catch (error) {
   ...
   */ const authenticatedGet = useCallback(async (endpoint, additionalHeaders)=>{
        try {
            return await executeAuthenticatedRequest({
                endpoint,
                method: 'GET',
   ...
   */ const authenticatedPut = useCallback(async (endpoint, data, additionalHeaders)=>{
        try {
            return await executeAuthenticatedRequest({
                endpoint,
                method: 'PUT',
   ...
   */ const authenticatedDelete = useCallback(async (endpoint, additionalHeaders)=>{
        try {
            return await executeAuthenticatedRequest({
                endpoint,
                method: 'DELETE',
