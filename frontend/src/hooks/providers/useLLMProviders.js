...
import { isValidProvidersArray, canExtractModelsFromProvider, isValidData, hasProviders } from '../utils/providerValidation';
 ...
 */ export function useLLMProviders({ storage = null, isAuthenticated = false, onLoadComplete } = {}) {
    const [availableModels, setAvailableModels] = useState([]);
    const [providers, setProviders] = useState([]);
    const [iterationLimit, setIterationLimit] = useState(undefined);
    const [defaultModel, setDefaultModel] = useState(undefined);
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        isAuthenticated
    ]); // storage and onLoadComplete accessed via closure
    return {
        availableModels,
        providers,
        iterationLimit,
