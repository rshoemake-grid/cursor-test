  ...
  describe('additional coverage for no-coverage mutants', () => {
        ...
        const providers: LLMProvider[] = [
          {
            ...
            type: 'openai',
            enabled: true,
            models: null as any, // Null models
          },
        ]
        ...
        const providers: LLMProvider[] = [
          {
            ...
            type: 'openai',
            enabled: true,
            models: [], // Empty array - exact boundary
          },
        ]
    ...
    describe('useLLMProviders - API data edge cases', () => {
      ...
      it('should handle data.providers.length === 0 exact boundary', async () => {
        mockApi.getLLMSettings.mockResolvedValue({
          providers: [], // Empty array - exact boundary
          iteration_limit: 10,
        })
  ...
  describe('mutation killers - additional conditional expressions', () => {
          ...
          providers: [
            {
              ...
              name: 'OpenAI',
              type: 'openai',
              enabled: true, // First condition true
              models: ['gpt-4'], // Second condition true, length > 0
            },
          ],
        })
          ...
          providers: [
            {
              ...
              name: 'Anthropic',
              type: 'anthropic',
              enabled: false, // First condition false
              models: ['claude-3-opus'],
            },
          ],
        })
          ...
          providers: [
            {
              ...
              type: 'anthropic',
              enabled: true,
              models: null as any, // Second condition false
            },
          ],
        })
          ...
          providers: [
            {
              ...
              type: 'anthropic',
              enabled: true,
              models: [], // Third condition false (length === 0)
            },
          ],
        })
    ...
    describe('mutation killers - exact comparisons and operators', () => {
      ...
      it('should verify exact comparison data.providers && data.providers.length > 0 - providers.length is exactly 0', async () => {
        mockApi.getLLMSettings.mockResolvedValue({
          providers: [], // length is 0, so > 0 is false
        })
      ...
      it('should verify logical AND provider.enabled && provider.models && provider.models.length > 0 - models is null', async () => {
        mockApi.getLLMSettings.mockResolvedValue({
          providers: [
            { id: 'openai', name: 'OpenAI', type: 'openai', enabled: true, models: null as any },
          ],
        })
