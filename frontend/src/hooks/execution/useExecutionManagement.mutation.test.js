...
describe('useExecutionManagement - Mutation Killers', ()=>{
    ...
    describe('Polling - exact comparisons', ()=>{
        it('should verify exec.status !== newStatus - status changed', async ()=>{
            ...
            expect(mockLoggerDebug).toHaveBeenCalledWith(expect.stringContaining('status changed'));
        });
        it('should verify exec.status !== newStatus - status unchanged', async ()=>{
            ...
            expect(mockLoggerDebug).not.toHaveBeenCalledWith(expect.stringContaining('status changed'));
        });
        ...
        it('should verify !exec.id.startsWith("pending-") in error handling', async ()=>{
            ...
            expect(mockLoggerError).toHaveBeenCalledWith(expect.stringContaining('Failed to fetch execution'), expect.any(Error));
        });
