...
describe('useWorkflowExecution - No Coverage Paths', ()=>{
    ...
    describe('handleConfirmExecute - catch blocks and optional chaining', ()=>{
        it('should handle JSON.parse throwing in catch block', async ()=>{
            ...
            expect(logger.error).toHaveBeenCalledWith('[WorkflowExecution] Failed to parse inputs:', expect.any(Error));
            expect(logger.error).toHaveBeenCalledWith('[WorkflowBuilder] Execution failed:', expect.any(Error));
        });
        it('should handle api.executeWorkflow error with optional chaining', async ()=>{
            ...
            expect(showError).toHaveBeenCalledWith('Failed to execute workflow: API error detail');
        });
        it('should handle api.executeWorkflow error without response.data', async ()=>{
            ...
            expect(showError).toHaveBeenCalledWith('Failed to execute workflow: Network error');
        });
        it('should handle api.executeWorkflow error without message', async ()=>{
            ...
            expect(showError).toHaveBeenCalledWith('Failed to execute workflow: Unknown error');
        });
