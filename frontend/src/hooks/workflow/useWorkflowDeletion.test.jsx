...
describe("useWorkflowDeletion", () => {
  ...
  describe("deleteSelectedWorkflows", () => {
    ...
    it("should filter out official workflows", async () => {
      ...
      await act(async () => {
        await result.current.deleteSelectedWorkflows(/* @__PURE__ */ new Set(["template-1", "template-2"]));
      });
    ...
    it("should delete workflows successfully", async () => {
      ...
      expect(mockSetSelectedTemplateIds).toHaveBeenCalledWith(/* @__PURE__ */ new Set());
  ...
  describe("deleteSelectedWorkflows edge cases", () => {
    ...
    it("should handle Promise.all with partial errors", async () => {
      ...
      mockDeleteTemplate.mockResolvedValueOnce(void 0).mockRejectedValueOnce(new Error("Delete failed"));
      const { result } = renderHook(
        () => useWorkflowDeletion({
          user: { id: "user-1", username: "testuser" },
          templates: workflows,
