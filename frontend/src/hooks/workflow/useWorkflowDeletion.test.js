...
describe('useWorkflowDeletion', ()=>{
    ...
    describe('deleteSelectedWorkflows', ()=>{
        it('should return early when no templates selected', async ()=>{
            const { result } = renderHook(()=>useWorkflowDeletion({
                    user: {
                        id: 'user-1',
                        username: 'testuser'
                    },
        ...
        it('should filter out official workflows', async ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith(expect.stringContaining('Cannot delete 1 official workflow(s)'));
        ...
        it('should show error when user owns no templates', async ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith('You can only delete workflows that you published');
            expect(mockDeleteTemplate).not.toHaveBeenCalled();
        });
        it('should show error when user owns no templates and official templates exist', async ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith('You can only delete workflows that you published (official workflows cannot be deleted)');
        });
        it('should show partial delete confirmation when user owns some templates', async ()=>{
            ...
            expect(mockShowConfirm).toHaveBeenCalledWith(expect.stringContaining('You can only delete 1 of 2 selected workflow(s)'), expect.objectContaining({
        ...
        it('should show full delete confirmation when user owns all templates', async ()=>{
            ...
            expect(mockShowConfirm).toHaveBeenCalledWith(expect.stringContaining('Are you sure you want to delete 2 selected workflow(s)'), expect.objectContaining({
        ...
        it('should handle delete error', async ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith(expect.stringContaining('Failed to delete workflows'));
        });
    ...
    describe('deleteSelectedWorkflows edge cases', ()=>{
        ...
        it('should handle Promise.all with partial errors', async ()=>{
            ...
            mockDeleteTemplate.mockResolvedValueOnce(undefined).mockRejectedValueOnce(new Error('Delete failed'));
            const { result } = renderHook(()=>useWorkflowDeletion({
                    user: {
                        id: 'user-1',
                        username: 'testuser'
    ...
    describe('mutation killers for deleteSelectedWorkflows', ()=>{
        ...
        it('should verify officialTemplates.length > 0 boundary (exactly 0)', async ()=>{
            ...
            expect(mockShowError).not.toHaveBeenCalledWith(expect.stringContaining('official workflow'));
        });
        it('should verify officialTemplates.length > 0 boundary (exactly 1)', async ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith(expect.stringContaining('official workflow'));
        });
        ...
        it('should verify userOwnedTemplates.length < deletableTemplates.length path', async ()=>{
            ...
            expect(mockShowConfirm).toHaveBeenCalledWith(expect.stringContaining('You can only delete 1 of 2 selected workflow(s)'), expect.any(Object));
        });
        ...
        describe('Error object structure variations', ()=>{
            describe('deleteSelectedWorkflows error handling', ()=>{
                ...
                it('should verify error.response.data.detail - data without detail property', async ()=>{
                    ...
                    expect(mockShowError).toHaveBeenCalledWith(expect.stringContaining('Error occurred'));
                });
                ...
                it('should verify error.response.data.detail - detail exists', async ()=>{
                    ...
                    // extractApiErrorMessage extracts from error.response.data.detail
                    expect(mockShowError).toHaveBeenCalledWith(expect.stringContaining('Template not found'));
                });
            });
        });
    });
    describe('no-coverage paths for deleteSelectedWorkflows', ()=>{
        describe('deleteSelectedWorkflows - catch blocks', ()=>{
            it('should handle api.deleteTemplate throwing error', async ()=>{
                ...
                expect(showError).toHaveBeenCalledWith(expect.stringContaining('Failed to delete workflows'));
            });
        });
    });
