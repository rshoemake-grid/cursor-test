...
describe('useWorkflowLoader', ()=>{
    ...
    const mockIsLoadingRef = {
        current: false
    };
    const mockLastLoadedWorkflowIdRef = {
        current: null
    };
    beforeEach(()=>{
        jest.clearAllMocks();
    ...
    describe('workflow loading', ()=>{
        ...
        it('should log loaded nodes', async ()=>{
            ...
            expect(logger.debug).toHaveBeenCalledWith('Loaded nodes:', expect.arrayContaining([
