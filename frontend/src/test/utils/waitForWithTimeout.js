 ...
 * })
 * ```
 */ export const waitForWithTimeoutFakeTimers = async (callback, timeoutOrOptions = 2000)=>{
    // Extract timeout value - handle both number and object formats
    const timeout = typeof timeoutOrOptions === 'number' ? timeoutOrOptions : timeoutOrOptions?.timeout ?? 2000;
