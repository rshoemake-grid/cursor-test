...
const defaultAgentNodeTemplates = [
  ...
  { type: "agent", label: "ADK Agent", icon: Bot, color: "text-indigo-600", description: "Google ADK agent (Gemini, tools)", agentType: "adk" }
];
...
function NodePanel({
  ...
  const [expandedCategories, setExpandedCategories] = useState({
    workflowNodes: false,
    agentNodes: true,
    // Expanded by default so users see Agent and ADK Agent options
    toolNodes: false,
    dataNodes: false
  });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-64 h-full bg-white border-r border-gray-200 p-4 overflow-y-auto", children: [
    /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-4", children: "Node Palette" }),
    /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mb-4", children: "Drag nodes onto the canvas" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { children: "Workflow Nodes" }),
            expandedCategories.workflowNodes ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })
          ]
        }
      ),
      expandedCategories.workflowNodes && /* @__PURE__ */ jsx("div", { className: "space-y-2", children: workflowNodeTemplates.map((template) => {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsx(Icon, { className: `w-4 h-4 ${template.color}` }),
                /* @__PURE__ */ jsx("span", { className: "font-medium text-sm text-gray-900", children: template.label })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: template.description })
            ]
          },
          template.type
        );
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 space-y-2", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { children: "Agent Nodes" }),
            expandedCategories.agentNodes ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })
          ]
        }
      ),
      expandedCategories.agentNodes && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            ref: fileInputRef,
        ...
        agentNodeTemplates.map((template, index) => {
          ...
          const templateData = template.agentType ? { agentType: template.agentType, label: template.label } : void 0;
          return /* @__PURE__ */ jsxs(
            "div",
            {
              draggable: true,
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600", children: template.description })
              ]
            },
            key
          );
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 space-y-2", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          className: "w-full flex items-center justify-between text-xs font-semibold text-gray-700 uppercase tracking-wide mb-2 hover:text-gray-900 transition-colors",
          children: [
            /* @__PURE__ */ jsx("span", { children: "Tool Nodes" }),
            expandedCategories.toolNodes ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })
          ]
        }
      ),
      expandedCategories.toolNodes && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 space-y-2", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          className: "w-full flex items-center justify-between text-xs font-semibold text-gray-700 uppercase tracking-wide mb-2 hover:text-gray-900 transition-colors",
          children: [
            /* @__PURE__ */ jsx("span", { children: "Data Nodes" }),
            expandedCategories.dataNodes ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4" })
          ]
        }
      ),
      expandedCategories.dataNodes && /* @__PURE__ */ jsx("div", { className: "space-y-2", children: dataNodeTemplates.map((template) => {
        const Icon = template.icon;
        return /* @__PURE__ */ jsxs(
          "div",
          {
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 p-3 bg-blue-50 rounded-lg", children: [
      /* @__PURE__ */ jsx("h4", { className: "text-xs font-semibold text-blue-900 mb-1", children: "\u{1F4A1} Tip" }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-blue-700", children: "Connect nodes by dragging from the circles (handles) on each node." })
    ] })
  ] });
}
export {
