  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        showCheckbox && /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 pt-1", children: /* @__PURE__ */ jsx(
          "input",
          {
            type: "checkbox",
            checked: isSelected,
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          execution.current_node && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-500", children: "Current Node:" }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700", children: execution.current_node })
          ] }),
          execution.status === "running" && execution.node_states && /* @__PURE__ */ jsx("div", { className: "mb-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-500", children: [
            /* @__PURE__ */ jsx("span", { children: "Progress:" }),
            /* @__PURE__ */ jsx("div", { className: "flex-1 bg-gray-200 rounded-full h-1.5 overflow-hidden max-w-xs", children: /* @__PURE__ */ jsx(
              "div",
              {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 text-xs text-gray-500", children: [
            ...
            execution.completed_at && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex flex-col items-end gap-2 flex-shrink-0", children: /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: (e) => {
              e.stopPropagation();
