...
describe('ExecutionFilters', ()=>{
    ...
    it('should render filter controls', ()=>{
        render(/*#__PURE__*/ _jsx(ExecutionFilters, {
    ...
    it('should update workflow filter', ()=>{
        ...
        const workflowSelect = screen.getByLabelText('Workflow').closest('select') || screen.getByRole('combobox', {
            name: /workflow/i
        });
    ...
    it('should update sort by', ()=>{
        ...
        const sortSelect = screen.getByLabelText('Sort By').closest('select') || screen.getByRole('combobox', {
            name: /sort by/i
        });
    ...
    it('should update sort order', ()=>{
        ...
        const orderSelect = screen.getByLabelText('Order').closest('select') || screen.getByRole('combobox', {
            name: /order/i
        });
