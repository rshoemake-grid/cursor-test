...
describe("ExecutionFilters", () => {
  ...
  it("should render filter controls", () => {
    render(
      /* @__PURE__ */ jsx(ExecutionFilters, { filters: defaultFilters, onFiltersChange: mockOnFiltersChange })
    );
  ...
  it("should toggle multiple status filters", () => {
    ...
    render(
      /* @__PURE__ */ jsx(ExecutionFilters, { filters: filtersWithStatus, onFiltersChange: mockOnFiltersChange })
    );
  ...
  it("should clear filters except search query when clear is clicked", () => {
    ...
    render(
      /* @__PURE__ */ jsx(ExecutionFilters, { filters: filtersWithAll, onFiltersChange: mockOnFiltersChange })
    );
