...
httpClient: _httpClient = defaultAdapters.createHttpClient() }) {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        isOpen,
        node
    ]); // Only depend on isOpen and node, not publishFormHook (updateForm is stable)
        ...
        try {
            ...
            if (storage) {
                try {
                    ...
                    const existingIndex = agents.findIndex((a)=>a.id === agentTemplate.id || a.name === agentTemplate.name && a.author_id === agentTemplate.author_id);
                    if (existingIndex >= 0) {
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ _jsx("div", {
                        ...
                        children: activeTab === 'tools' ? /*#__PURE__*/ _jsxs("div", {
                            className: "space-y-4",
                            children: [
                                /*#__PURE__*/ _jsxs("div", {
                                    children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ _jsx("select", {
                                            ...
                                            children: TEMPLATE_CATEGORIES.map((cat)=>/*#__PURE__*/ _jsx("option", {
                                                    value: cat,
                                                    children: formatCategory(cat).split(' ').map((w)=>w.charAt(0).toUpperCase() + w.slice(1)).join(' ')
                                                }, cat))
                                        })
                                    ]
                                }),
                        ...
                        }) : activeTab === 'agents' ? /*#__PURE__*/ _jsxs("div", {
                            className: "space-y-4",
                            children: [
                                /*#__PURE__*/ _jsxs("div", {
                                    children: [
                                ...
                                /*#__PURE__*/ _jsxs("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ _jsx("p", {
                                            ...
                                            children: "Workflow name cannot be changed when publishing"
                                        })
                                    ]
                                }),
                                /*#__PURE__*/ _jsxs("div", {
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ _jsx("button", {
                                ...
                                children: isPublishing ? /*#__PURE__*/ _jsxs(_Fragment, {
                                    children: [
                                        /*#__PURE__*/ _jsx("div", {
