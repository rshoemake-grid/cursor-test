...
describe("MarketplaceTabContent", () => {
  ...
  it("should show loading state", () => {
    render(/* @__PURE__ */jsx(MarketplaceTabContent, {
      ...defaultProps,
      loading: true
    }));
  ...
  it("should render agents tab content", () => {
    ...
    expect(TemplateGrid).toHaveBeenCalledWith(expect.objectContaining({
      items: mockAgents,
      type: "agent",
  ...
  it("should pass selection handlers correctly", () => {
    ...
    render(/* @__PURE__ */jsx(MarketplaceTabContent, {
      ...
      isAgentsTab: true,
      agentSelection: {
        selectedIds: /* @__PURE__ */new Set(["agent-1"]),
        toggle: mockToggle
      }
    }));
    expect(TemplateGrid).toHaveBeenCalledWith(expect.objectContaining({
