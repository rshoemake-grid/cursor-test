...
describe("AddProviderForm", () => {
  ...
  describe("when showAddProvider is false", () => {
    it("should render add provider button", () => {
      render(/* @__PURE__ */ jsx(AddProviderForm, { ...defaultProps }));
    ...
    it("should have hover styles on button", () => {
      const { container } = render(/* @__PURE__ */ jsx(AddProviderForm, { ...defaultProps }));
  ...
  describe("when showAddProvider is true", () => {
    it("should render add provider form", () => {
      render(/* @__PURE__ */ jsx(AddProviderForm, { ...defaultProps, showAddProvider: true }));
    ...
    it("should display selected template value", () => {
      render(/* @__PURE__ */ jsx(AddProviderForm, { ...defaultProps, showAddProvider: true, selectedTemplate: "anthropic" }));
      const select = screen.getByLabelText("Select Provider Type");
    ...
    it("should have proper form styling", () => {
      const { container } = render(/* @__PURE__ */ jsx(AddProviderForm, { ...defaultProps, showAddProvider: true }));
