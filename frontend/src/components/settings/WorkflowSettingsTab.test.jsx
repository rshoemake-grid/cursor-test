...
describe("WorkflowSettingsTab", () => {
  ...
  it("should display current iteration limit", () => {
    render(/* @__PURE__ */ jsx(WorkflowSettingsTab, { ...defaultProps, iterationLimit: 15 }));
    const input = screen.getByLabelText("Iteration limit");
  ...
  it("should display current default model", () => {
    render(/* @__PURE__ */ jsx(WorkflowSettingsTab, { ...defaultProps, defaultModel: "gpt-4" }));
    const select = screen.getByLabelText("Default Model");
  ...
  it("should not show model confirmation when defaultModel is empty", () => {
    render(/* @__PURE__ */ jsx(WorkflowSettingsTab, { ...defaultProps, defaultModel: "" }));
  ...
  it("should handle providers with no models", () => {
    ...
    render(/* @__PURE__ */ jsx(WorkflowSettingsTab, { ...defaultProps, providers: providersWithoutModels }));
    const select = screen.getByLabelText("Default Model");
  ...
  it("should handle providers with null/undefined models", () => {
    ...
    render(/* @__PURE__ */ jsx(WorkflowSettingsTab, { ...defaultProps, providers: providersWithNullModels }));
    const select = screen.getByLabelText("Default Model");
    expect(select.options.length).toBe(1);
  });
