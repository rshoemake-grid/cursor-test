...
function ProviderForm({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg shadow-sm border border-gray-200 p-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900", children: provider.name }),
          /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-500 capitalize", children: provider.type })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: isExpanded ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-5 h-5" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-5 h-5" })
          }
        ),
        /* @__PURE__ */ jsx(
          "button",
    ...
    isExpanded && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: showApiKeys[provider.id] ? /* @__PURE__ */ jsx(EyeOff, { className: "w-5 h-5" }) : /* @__PURE__ */ jsx(Eye, { className: "w-5 h-5" })
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Base URL" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Default Model" }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx(
            "select",
            {
              ...
              children: (provider.models || []).map((model) => /* @__PURE__ */ jsx("option", { value: model, children: model }, model))
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pt-2", children: [
        ...
        testResult?.status === "success" && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-green-600", children: [
          /* @__PURE__ */ jsx(CheckCircle, { className: "w-5 h-5" }),
          /* @__PURE__ */ jsx("span", { children: testResult.message })
        ] }),
        testResult?.status === "error" && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-red-600", children: [
            /* @__PURE__ */ jsx(XCircle, { className: "w-5 h-5" }),
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Connection failed" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-red-700 ml-7", children: testResult.message })
        ] })
      ] })
    ] })
  ] });
...
function ModelList({
  ...
  // Unused but part of interface - prefix with underscore to indicate intentionally unused
}) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Models" }),
    /* @__PURE__ */ jsx("div", { className: "space-y-1", children: (provider.models || []).map((model, index) => {
      const modelKey = `${provider.id}-${model}-${index}`;
      const isExpanded = isModelExpanded(provider.id, model);
      return /* @__PURE__ */ jsxs("div", { className: "border-b border-gray-100 last:border-b-0", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-4 h-4 flex items-center justify-center text-gray-600 font-bold", children: isExpanded ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-4 h-4", strokeWidth: 2.5 }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4", strokeWidth: 2.5 }) }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: model }),
              model === provider.defaultModel && /* @__PURE__ */ jsx("span", { className: "text-xs px-2 py-0.5 bg-primary-100 text-primary-700 rounded", children: "Default" })
            ]
          }
        ),
        isExpanded && /* @__PURE__ */ jsxs("div", { className: "ml-6 mt-2 mb-2 space-y-3 pb-2", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-xs font-medium text-gray-700 mb-1", children: "Model Name" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
