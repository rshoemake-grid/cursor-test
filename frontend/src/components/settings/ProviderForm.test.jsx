...
describe('ProviderForm', ()=>{
    ...
    it('should render provider name and type', ()=>{
        render(/*#__PURE__*/ _jsx(ProviderForm, {
            ...defaultProps
        }));
    ...
    describe('Model list interactions', ()=>{
        ...
        it('should show model edit form when expanded', ()=>{
            ...
            const modelNameInput = inputs.find((input)=>input.getAttribute('value') === 'gpt-4' || input.closest('div')?.querySelector('label')?.textContent === 'Model Name');
        ...
        it('should show error when trying to delete last model', ()=>{
            ...
            const removeButton = screen.getByText('Remove');
            fireEvent.click(removeButton);
            expect(mockShowError).toHaveBeenCalledWith('Cannot delete the last model. Add another model first.');
        });
