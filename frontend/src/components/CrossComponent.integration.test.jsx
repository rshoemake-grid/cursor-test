...
jest.mock('./WorkflowBuilder/WorkflowBuilderLayout', () => {
  ...
  return {
    __esModule: true,
    WorkflowBuilderLayout: () => /*#__PURE__*/_jsx("div", {
...
jest.mock('./WorkflowBuilder/WorkflowBuilderDialogs', () => {
  ...
  return {
    __esModule: true,
    WorkflowBuilderDialogs: () => /*#__PURE__*/_jsx("div", {
...
jest.mock('../components/settings/SettingsHeader', () => {
  ...
  return {
    __esModule: true,
    SettingsHeader: () => /*#__PURE__*/_jsx("div", {
...
jest.mock('../components/settings/SettingsTabs', () => {
  ...
  return {
    __esModule: true,
    SettingsTabs: () => /*#__PURE__*/_jsx("div", {
...
jest.mock('../components/settings/SettingsTabContent', () => {
  ...
  return {
    __esModule: true,
    SettingsTabContent: () => /*#__PURE__*/_jsx("div", {
