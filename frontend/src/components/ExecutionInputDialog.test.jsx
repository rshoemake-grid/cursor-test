...
describe('ExecutionInputDialog', ()=>{
    ...
    it('should not render when isOpen is false', ()=>{
        render(/*#__PURE__*/ _jsx(ExecutionInputDialog, {
            isOpen: false,
            onClose: mockOnClose,
    ...
    it('should reset inputs when dialog closes and reopens', ()=>{
        ...
        const { rerender } = render(/*#__PURE__*/ _jsx(ExecutionInputDialog, {
            isOpen: true,
            onClose: mockOnClose,
            onSubmit: mockOnSubmit,
            nodes: nodesWithInputs
        ...
        // Close dialog
        rerender(/*#__PURE__*/ _jsx(ExecutionInputDialog, {
            isOpen: false,
            onClose: mockOnClose,
            onSubmit: mockOnSubmit,
            nodes: nodesWithInputs
    ...
    it('should handle textarea input type', ()=>{
        ...
        const { container } = render(/*#__PURE__*/ _jsx(ExecutionInputDialog, {
            isOpen: true,
            onClose: mockOnClose,
            onSubmit: mockOnSubmit,
