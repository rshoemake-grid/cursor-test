...
describe('NodePanel', ()=>{
    ...
    it('should render node palette', ()=>{
        render(/*#__PURE__*/ _jsx(NodePanel, {}));
    ...
    it('should handle drag start for ADK Agent with agent_type and adk_config', ()=>{
        ...
        const customAgentJson = dragEvent.dataTransfer.setData.mock.calls.find((c)=>c[0] === 'application/custom-agent')?.[1];
    ...
    describe('Dependency Injection', ()=>{
        ...
        it('should use window event listeners for storage events', ()=>{
            ...
            const { unmount } = render(/*#__PURE__*/ _jsx(NodePanel, {
                storage: mockStorage
            }));
        ...
        it('should handle storage event with injected storage', async ()=>{
            const mockStorage = {
                getItem: jest.fn().mockReturnValueOnce(null) // Initial load
