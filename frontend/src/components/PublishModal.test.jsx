...
describe("PublishModal", () => {
  ...
  it("should not render when isOpen is false", () => {
    render(/* @__PURE__ */ jsx(PublishModal, { ...mockProps, isOpen: false }));
    expect(screen.queryByText("Publish to Marketplace")).not.toBeInTheDocument();
  });
  it("should render when isOpen is true", () => {
    render(/* @__PURE__ */ jsx(PublishModal, { ...mockProps }));
  ...
  it("should disable submit button when isPublishing is true", () => {
    render(/* @__PURE__ */ jsx(PublishModal, { ...mockProps, isPublishing: true }));
  ...
  it('should show "Publish" text when isPublishing is false', () => {
    render(/* @__PURE__ */ jsx(PublishModal, { ...mockProps, isPublishing: false }));
