...
describe("ToastContainer", () => {
  ...
  it("should render nothing when toasts array is empty", () => {
    const { container } = render(
      /* @__PURE__ */ jsx(ToastContainer, { toasts: [], onRemoveToast: mockOnRemoveToast })
    );
  ...
  it("should render multiple toasts", () => {
    ...
    render(/* @__PURE__ */ jsx(ToastContainer, { toasts, onRemoveToast: mockOnRemoveToast }));
    expect(screen.getByText("First message")).toBeInTheDocument();
    expect(screen.getByText("Second message")).toBeInTheDocument();
  });
  it("should pass onRemoveToast to each toast", () => {
    const toasts = [{ id: "toast-1", message: "Test message", type: "info" }];
    render(/* @__PURE__ */ jsx(ToastContainer, { toasts, onRemoveToast: mockOnRemoveToast }));
  ...
  it("should have correct container styling", () => {
    const toasts = [{ id: "toast-1", message: "Test", type: "info" }];
    const { container } = render(
      /* @__PURE__ */ jsx(ToastContainer, { toasts, onRemoveToast: mockOnRemoveToast })
    );
