...
function PropertyPanel({ selectedNodeId, setSelectedNodeId, selectedNodeIds, nodes: nodesProp, onSave, onSaveWorkflow, storage = defaultAdapters.createLocalStorageAdapter() }) {
  ...
  if (isExplicitlyFalse(panelOpen)) {
    return /* @__PURE__ */ jsx("div", { className: "fixed right-0 top-1/2 -translate-y-1/2 z-10", children: /* @__PURE__ */ jsx(
      "button",
      {
  ...
  if (multipleSelected) {
    return /* @__PURE__ */ jsxs("div", { className: "w-80 h-full bg-white border-l border-gray-200 p-4 overflow-y-auto", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-4", children: "Properties" }),
      /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-500 mb-2", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400", children: "Select a single node to edit its properties" }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-2", children: "You can drag selected nodes together to move them" })
      ] })
    ] });
  }
  const handleClose = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative w-80 h-full bg-white border-l border-gray-200 p-4 overflow-y-auto", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: handleClose,
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "Properties" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            title: "Save changes",
            children: saveStatus === "saved" ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(Check, { className: "w-4 h-4" }),
              "Saved"
            ] }) : saveStatus === "saving" ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(Save, { className: "w-4 h-4 animate-pulse" }),
              "Saving..."
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "node-description", className: "block text-sm font-medium text-gray-700 mb-1", children: "Description" }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
            id: "node-description",
      ...
      selectedNode.type !== "start" && selectedNode.type !== "end" && /* @__PURE__ */ jsx(
        InputConfiguration,
        {
          inputs: nodeInputs,
          showAddInput,
      ...
      isToolNode(selectedNode) && /* @__PURE__ */ jsx(
        ToolNodeEditor,
        {
          node: selectedNode,
          onUpdate: handleUpdate,
      ...
      isAgentNode(selectedNode) && /* @__PURE__ */ jsx(
        AgentNodeEditor,
        {
          node: selectedNode,
          availableModels,
      ...
      isConditionNode(selectedNode) && /* @__PURE__ */ jsx(
        ConditionNodeEditor,
        {
          node: selectedNode,
          onConfigUpdate: handleConfigUpdate
      ...
      isLoopNode(selectedNode) && /* @__PURE__ */ jsx(
        LoopNodeEditor,
        {
          node: selectedNode,
          onUpdate: handleUpdate,
      ...
      isInputNode(selectedNode) && ["gcp_bucket", "aws_s3", "gcp_pubsub", "local_filesystem"].includes(selectedNode.type) && /* @__PURE__ */ jsx(
        InputNodeEditor,
        {
          node: selectedNode,
          onConfigUpdate: handleConfigUpdate
      ...
      selectedNode.type === "database" && /* @__PURE__ */ jsx(
        DatabaseNodeEditor,
        {
          node: selectedNode,
          onConfigUpdate: handleConfigUpdate
      ...
      selectedNode.type === "firebase" && /* @__PURE__ */ jsx(
        FirebaseNodeEditor,
        {
          node: selectedNode,
          onConfigUpdate: handleConfigUpdate
      ...
      selectedNode.type === "bigquery" && /* @__PURE__ */ jsx(
        BigQueryNodeEditor,
        {
          node: selectedNode,
          onConfigUpdate: handleConfigUpdate
