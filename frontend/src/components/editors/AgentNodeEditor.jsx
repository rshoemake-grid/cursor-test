...
function AgentNodeEditor({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border-t pt-4", children: [
    /* @__PURE__ */ jsx("h4", { className: "text-sm font-semibold text-gray-900 mb-3", children: "LLM Agent Configuration" }),
    /* @__PURE__ */ jsxs("div", { className: "mb-4 p-3 bg-gray-50 border border-gray-200 rounded-lg", children: [
      /* @__PURE__ */ jsx(
        "label",
        {
          htmlFor: "agent-type",
      ...
      /* @__PURE__ */ jsxs(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("option", { value: "workflow", children: "Workflow Agent (Default)" }),
            /* @__PURE__ */ jsx("option", { value: "adk", children: "ADK Agent (Google ADK)" })
          ]
        }
      ),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: agentType === "adk" ? "Uses Google ADK for agent execution. Requires Gemini models." : "Uses direct LLM API calls with workflow orchestration." })
    ] }),
    agentType === "adk" && /* @__PURE__ */ jsxs("div", { className: "mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg", children: [
      /* @__PURE__ */ jsx("h5", { className: "text-sm font-semibold text-blue-900 mb-2", children: "ADK Configuration" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-3", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Available: google_search, load_web_page, enterprise_web_search" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx(
        "select",
        {
          ...
          children: availableModels.length > 0 ? availableModels.map((model) => /* @__PURE__ */ jsx("option", { value: model.value, children: model.label }, model.value)) : /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("option", { value: "gpt-4o-mini", children: "GPT-4o Mini (OpenAI)" }),
            /* @__PURE__ */ jsx("option", { value: "gpt-4o", children: "GPT-4o (OpenAI)" }),
            /* @__PURE__ */ jsx("option", { value: "gpt-4", children: "GPT-4 (OpenAI)" }),
            /* @__PURE__ */ jsx("option", { value: "gpt-3.5-turbo", children: "GPT-3.5 Turbo (OpenAI)" })
          ] })
        }
      ),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: availableModels.length > 0 ? `This agent will use the configured LLM provider with the selected model` : "This agent will call the OpenAI API with this model. Configure providers in Settings." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
      ...
      /* @__PURE__ */ jsx("p", { id: "system-prompt-help", className: "text-xs text-gray-500 mt-1", children: "Instructions that define the agent's role and behavior" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
      /* @__PURE__ */ jsxs(
        "label",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-gray-500 mt-1", children: [
        /* @__PURE__ */ jsx("span", { children: "Focused (0.0)" }),
        /* @__PURE__ */ jsx("span", { children: "Creative (1.0)" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
      /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx("p", { id: "max-tokens-help", className: "text-xs text-gray-500 mt-1", children: "Maximum length of the agent's response" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-3 mt-4", role: "status", children: [
      /* @__PURE__ */ jsx("p", { className: "text-xs text-blue-900 font-medium mb-1", children: "\u{1F916} This is a Real LLM Agent" }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-blue-700", children: "When executed, this agent will call OpenAI's API with your configured model and prompt. The agent receives data from its inputs and produces output for the next nodes." })
    ] }),
