...
export default function LocalFileSystemEditor({ node, onConfigUpdate }) {
    const inputConfig = node.data.input_config || {};
    const filePathRef = useRef(null);
    const filePatternRef = useRef(null);
    const [filePathValue, setFilePathValue] = useInputFieldSync(filePathRef, inputConfig.file_path, EMPTY_STRING);
    const [filePatternValue, setFilePatternValue] = useInputFieldSync(filePatternRef, inputConfig.file_pattern, EMPTY_STRING);
    const [modeValue, setModeValue] = useInputFieldSyncSimple(inputConfig.mode, INPUT_MODE.READ);
    const [overwriteValue, setOverwriteValue] = useInputFieldSyncSimple(inputConfig.overwrite, DEFAULT_OVERWRITE);
    return /*#__PURE__*/ _jsxs("div", {
        className: "border-t pt-4",
        children: [
            /*#__PURE__*/ _jsx("h4", {
                className: "text-sm font-semibold text-gray-900 mb-3",
                children: "Local File System Configuration"
            }),
            /*#__PURE__*/ _jsxs("div", {
                className: "mb-3",
                children: [
            ...
            modeValue === INPUT_MODE.READ && /*#__PURE__*/ _jsxs("div", {
                className: "mt-3",
                children: [
                    /*#__PURE__*/ _jsx("label", {
                        htmlFor: "filesystem-pattern",
                        className: "block text-sm font-medium text-gray-700 mb-1",
                        children: "File Pattern (optional)"
                    }),
                    /*#__PURE__*/ _jsx("input", {
            ...
            modeValue === INPUT_MODE.WRITE && /*#__PURE__*/ _jsx("div", {
                className: "mt-3",
                children: /*#__PURE__*/ _jsxs("label", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsx("span", {
                            ...
                            children: "Overwrite existing file"
                        })
                    ]
                })
            })
