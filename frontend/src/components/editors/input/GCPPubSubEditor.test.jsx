...
describe("GCPPubSubEditor", () => {
  ...
  describe("Component Rendering", () => {
    it("should render GCP Pub/Sub configuration section", () => {
      ...
      render(/* @__PURE__ */ jsx(GCPPubSubEditor, { node, onConfigUpdate: mockOnConfigUpdate }));
