...
describe("GCPBucketEditor", () => {
  ...
  describe("Component Rendering", () => {
    it("should render GCP Bucket configuration section", () => {
      ...
      render(/* @__PURE__ */ jsx(GCPBucketEditor, { node, onConfigUpdate: mockOnConfigUpdate }));
