...
describe("AWSS3Editor", () => {
  ...
  describe("Component Rendering", () => {
    it("should render AWS S3 configuration section", () => {
      ...
      render(/* @__PURE__ */ jsx(AWSS3Editor, { node, onConfigUpdate: mockOnConfigUpdate }));
