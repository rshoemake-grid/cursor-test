...
describe('LoopNodeEditor', ()=>{
    ...
    it('should render loop configuration fields', ()=>{
        render(/*#__PURE__*/ _jsx(LoopNodeEditor, {
            node: mockNode,
    ...
    it('should not update max iterations when input is focused', async ()=>{
        const { rerender } = render(/*#__PURE__*/ _jsx(LoopNodeEditor, {
            node: mockNode,
            onUpdate: mockOnUpdate,
            onConfigUpdate: mockOnConfigUpdate
        }));
        ...
        rerender(/*#__PURE__*/ _jsx(LoopNodeEditor, {
            node: updatedNode,
            onUpdate: mockOnUpdate,
            onConfigUpdate: mockOnConfigUpdate
        }));
    ...
    describe('edge cases', ()=>{
        ...
        it('should handle all loop_type values', ()=>{
            ...
            for (const loopType of loopTypes){
                ...
                const { unmount } = render(/*#__PURE__*/ _jsx(LoopNodeEditor, {
                    node: node,
                    onUpdate: mockOnUpdate,
                    onConfigUpdate: mockOnConfigUpdate
                }));
