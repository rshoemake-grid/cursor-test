...
describe('InputNodeEditor', ()=>{
    ...
    describe('GCP Bucket Configuration', ()=>{
        ...
        it('should render GCP bucket configuration fields', ()=>{
            render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: gcpBucketNode,
    ...
    describe('State synchronization', ()=>{
        ...
        it('should update local state when node data changes', ()=>{
            ...
            const { rerender } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: node,
                onConfigUpdate: mockOnConfigUpdate
            }));
            const updatedNode = {
            ...
            rerender(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: updatedNode,
                onConfigUpdate: mockOnConfigUpdate
            }));
        ...
        it('should handle all input types rendering correctly', ()=>{
            ...
            const { unmount: unmount1 } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: gcpBucketNode,
                onConfigUpdate: mockOnConfigUpdate
            }));
            ...
            const { unmount: unmount2 } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: awsS3Node,
                onConfigUpdate: mockOnConfigUpdate
            }));
            ...
            const { unmount: unmount3 } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: pubsubNode,
                onConfigUpdate: mockOnConfigUpdate
            }));
            ...
            const { unmount: unmount4 } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: filesystemNode,
                onConfigUpdate: mockOnConfigUpdate
            }));
            ...
            const { unmount: unmount5 } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: databaseNode,
                onConfigUpdate: mockOnConfigUpdate
            }));
            expect(screen.getByText(/Database Configuration/i)).toBeInTheDocument();
            ...
            const { unmount: unmount6 } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: firebaseNode,
                onConfigUpdate: mockOnConfigUpdate
            }));
            expect(screen.getByText(/Firebase Configuration/i)).toBeInTheDocument();
            ...
            const { unmount: unmount7 } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                node: bigqueryNode,
                onConfigUpdate: mockOnConfigUpdate
            }));
            expect(screen.getByText(/BigQuery Configuration/i)).toBeInTheDocument();
        ...
        it('should handle mode value changes for all node types', ()=>{
            ...
            nodeTypes.forEach((type)=>{
                ...
                const { unmount } = render(/*#__PURE__*/ _jsx(InputNodeEditor, {
                    node: node,
                    onConfigUpdate: mockOnConfigUpdate
                }));
