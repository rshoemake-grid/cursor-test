...
const renderWithAuth = ui => render(/* @__PURE__ */jsx(AuthProvider, {
  children: ui
}));
describe("ExecutionConsole - Additional Coverage", () => {
  ...
  const mockExecution = {
    id: "exec-123",
    status: "running",
    startedAt: /* @__PURE__ */new Date("2024-01-01T00:00:00Z"),
    nodes: {},
    logs: [{
      level: "INFO",
  ...
  describe("Tab Management", () => {
    it("should switch between chat and execution tabs", async () => {
      renderWithAuth(/* @__PURE__ */jsx(ExecutionConsole, {
  ...
  describe("Resize Functionality", () => {
    it("should handle resize mouse down", () => {
      ...
      const resizeHandle = resizeHandles.find(btn => btn.className.includes("cursor-ns-resize"));
      if (resizeHandle) {
  ...
  describe("Active Execution Switching", () => {
    it("should switch to new execution tab when activeExecutionId changes", () => {
      ...
      rerender(/* @__PURE__ */jsx(AuthProvider, {
        children: /* @__PURE__ */jsx(ExecutionConsole, {
          activeWorkflowId: "workflow-1",
          executions: [mockExecution],
          activeExecutionId: "exec-123"
        })
