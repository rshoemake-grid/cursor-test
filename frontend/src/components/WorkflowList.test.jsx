...
describe('WorkflowList', ()=>{
    ...
    it('should render loading state initially', ()=>{
        ...
        renderWithRouter(/*#__PURE__*/ _jsx(WorkflowList, {
    ...
    it('should handle bulk duplicate', async ()=>{
        mockApi.getWorkflows.mockResolvedValue(mockWorkflows);
        mockApi.duplicateWorkflow.mockResolvedValueOnce({
            ...mockWorkflows[0],
            id: 'workflow-1-copy',
    ...
    describe('Publish functionality', ()=>{
        it('should open publish modal when publish button is clicked', async ()=>{
            ...
            const publishButtons = screen.queryAllByRole('button').filter((btn)=>btn.textContent?.includes('Publish') || btn.getAttribute('title')?.includes('Publish'));
        ...
        it('should handle publish form field changes', async ()=>{
            ...
            if (publishButtons.length > 0) {
                ...
                // Change form fields
                const categorySelect = screen.queryByLabelText(/Category/i) || screen.queryAllByRole('combobox').find((sel)=>sel.closest('div')?.textContent?.includes('Category'));
                if (categorySelect) {
