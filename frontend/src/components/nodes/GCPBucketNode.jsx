...
function GCPBucketNode({ data, selected }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: `px-4 py-3 shadow-lg rounded-lg bg-white border-2 min-w-[200px] max-w-[200px] ${hasError ? "border-red-500 border-4 shadow-xl ring-2 ring-red-200" : selected ? "border-orange-500 border-4 shadow-xl ring-2 ring-orange-200" : "border-orange-300"}`,
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm text-gray-900 truncate flex-1 min-w-0", children: String(data.label || "GCP Bucket") })
        ] }),
        ...
        data.input_config?.object_path && /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-600 bg-gray-50 px-2 py-1 rounded mb-1 truncate", children: [
          "File: ",
          getFilename(data.input_config.object_path)
        ] }),
