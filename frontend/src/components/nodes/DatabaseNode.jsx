...
function DatabaseNode({ data, selected }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: `relative px-4 py-3 shadow-lg rounded-lg bg-white border-2 min-w-[200px] max-w-[200px] ${hasError ? "border-red-500 border-4 shadow-xl ring-2 ring-red-200" : selected ? "border-indigo-500 border-4 shadow-xl ring-2 ring-indigo-200" : "border-indigo-300"}`,
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
          /* @__PURE__ */ jsx("div", { className: "p-1.5 bg-indigo-100 rounded flex-shrink-0", children: /* @__PURE__ */ jsx(Database, { className: "w-4 h-4 text-indigo-600" }) }),
          /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm text-gray-900 truncate flex-1 min-w-0", children: String(data.label || "Database") })
        ] }),
        ...
        inputConfig.database_type && /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-600 bg-gray-50 px-2 py-1 rounded mb-1 truncate", children: [
          "Type: ",
          inputConfig.database_type
        ] }),
        inputConfig.database_name && /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-600 bg-gray-50 px-2 py-1 rounded mb-1 truncate", children: [
          "DB: ",
