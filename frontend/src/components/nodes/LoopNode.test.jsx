...
describe("LoopNode", () => {
  it("should render loop node", () => {
    renderWithProvider(/* @__PURE__ */ jsx(LoopNode, { selected: false, data: { label: "Test Loop" }, id: "loop-1" }));
    expect(screen.getByText("Test Loop")).toBeInTheDocument();
  });
  it("should show selected state", () => {
    const { container } = renderWithProvider(/* @__PURE__ */ jsx(LoopNode, { selected: true, data: { label: "Test" }, id: "loop-1" }));
