...
export default function ConditionNode({ data, selected }) {
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            ...
            data.condition_config?.condition_type && /*#__PURE__*/ _jsxs("div", {
                className: "text-xs text-gray-600 bg-gray-50 px-2 py-1 rounded truncate mb-2",
                children: [
            ...
            /*#__PURE__*/ _jsx("div", {
                className: "relative mt-2 pt-2 border-t border-gray-200",
