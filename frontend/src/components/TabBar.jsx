...
function TabBar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center bg-gray-100 border-b border-gray-300 px-2", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center flex-1 overflow-x-auto", children: tabs.map((tab) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        className: `
            ...
            `,
        children: [
          tab.isUnsaved && /* @__PURE__ */ jsx("div", { className: "w-2 h-2 bg-blue-500 rounded-full", title: "Unsaved changes" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm whitespace-nowrap", children: editingTabId === tab.id ? /* @__PURE__ */ jsx(
            "input",
            {
              ref: editingInputRef,
              value: editingName,
