...
describe("KeyboardHandler", () => {
  ...
  it("should render without crashing", () => {
    const { container } = render(/* @__PURE__ */ jsx(KeyboardHandler, { ...mockProps }));
    expect(container.firstChild).toBeNull();
  });
  it("should call useKeyboardShortcuts with correct props", () => {
    render(/* @__PURE__ */ jsx(KeyboardHandler, { ...mockProps }));
  ...
  it("should pass clipboardNode to hook", () => {
    ...
    render(/* @__PURE__ */ jsx(KeyboardHandler, { ...mockProps, clipboardNode }));
    expect(mockUseKeyboardShortcuts).toHaveBeenCalledWith(
  ...
  it("should handle null selectedNodeId", () => {
    render(/* @__PURE__ */ jsx(KeyboardHandler, { ...mockProps, selectedNodeId: null }));
    expect(mockUseKeyboardShortcuts).toHaveBeenCalledWith(
      expect.objectContaining({
        selectedNodeId: null
      })
