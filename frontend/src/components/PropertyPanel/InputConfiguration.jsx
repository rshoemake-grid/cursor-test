 ...
 */ export function InputConfiguration({ inputs, showAddInput, onAddInput, onRemoveInput, onUpdateInput, onShowAddInput }) {
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ _jsx("div", {
                ...
                children: safeInputs.map((input, index)=>/*#__PURE__*/ _jsxs("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ _jsx("input", {
                                                ...
                                                onChange: (e)=>{
                                                    ...
                                                    onUpdateInput(index, 'source_node', isNotEmpty(value) ? value : undefined);
                                                },
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsxs("form", {
                            onSubmit: (e)=>{
                                ...
                                onAddInput(formData.get('inputName'), formData.get('sourceNode'), formData.get('sourceField'));
                            },
                            children: [
                                /*#__PURE__*/ _jsxs("div", {
                                    className: "space-y-3",
                                        ...
                                        /*#__PURE__*/ _jsxs("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ _jsx("p", {
                                                    ...
                                                    children: "Name this agent will use to access the data"
                                                })
                                            ]
                                        }),
                                        /*#__PURE__*/ _jsxs("div", {
                                            children: [
                                                /*#__PURE__*/ _jsx("label", {
                                                    className: "block text-xs font-medium text-gray-700 mb-1",
                                                    children: "Source Node ID (optional)"
                                                }),
                                                /*#__PURE__*/ _jsx("input", {
                                                    name: "sourceNode",
                                                    type: "text",
                                                ...
                                                /*#__PURE__*/ _jsx("p", {
                                                    className: "text-xs text-gray-500 mt-1",
                                                    children: "Get data from another node's output. Leave blank to get from workflow input variables."
                                                })
                                            ]
                                        }),
                                        /*#__PURE__*/ _jsxs("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ _jsx("p", {
                                                    className: "text-xs text-gray-500 mt-1",
                                                    children: "Which field to get from the source (usually 'output')"
                                                })
                                            ]
                                        })
                                    ]
            ...
            /*#__PURE__*/ _jsx("div", {
                ...
                children: "💡 Inputs connect this node to data from previous nodes or workflow variables"
            })
        ]
    });
}
