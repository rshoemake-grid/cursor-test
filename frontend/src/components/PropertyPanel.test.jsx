...
const renderWithProvider = (component)=>{
    return render(/*#__PURE__*/ _jsx(AuthProvider, {
        children: /*#__PURE__*/ _jsx(ReactFlowProvider, {
            children: component
        })
    }));
};
...
describe('PropertyPanel', ()=>{
    ...
    it('should render PropertyPanel', ()=>{
        renderWithProvider(/*#__PURE__*/ _jsx(PropertyPanel, {
            selectedNodeId: null,
    ...
    it('should update when selectedNodeId changes', ()=>{
        ...
        mockGetNodes.mockReturnValue(mockNodes);
        const { rerender } = renderWithProvider(/*#__PURE__*/ _jsx(PropertyPanel, {
            selectedNodeId: "node-1",
            setSelectedNodeId: mockSetSelectedNodeId
        }));
        expect(screen.getByTestId('agent-node-editor')).toBeInTheDocument();
        rerender(/*#__PURE__*/ _jsx(AuthProvider, {
            children: /*#__PURE__*/ _jsx(ReactFlowProvider, {
                children: /*#__PURE__*/ _jsx(PropertyPanel, {
    ...
    it('should handle node with no name or label in delete confirmation', async ()=>{
        ...
        fireEvent.click(deleteButton);
        await waitForWithTimeout(()=>{
            expect(mockShowConfirm).toHaveBeenCalledWith(expect.stringContaining('node-1'), expect.any(Object));
        });
    });
            ...
            if (addInputButton) {
                ...
                await waitForWithTimeout(()=>{
                    ...
                    if (modal) {
                        ...
                        const submitButton = submitButtons.find((btn)=>btn.closest('[role="dialog"]') === modal);
