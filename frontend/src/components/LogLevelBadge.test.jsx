...
describe('LogLevelBadge', ()=>{
    ...
    it('should apply correct classes for INFO level', ()=>{
        const { container } = render(/*#__PURE__*/ _jsx(LogLevelBadge, {
            level: "INFO"
        }));
    ...
    describe('edge cases', ()=>{
        ...
        it('should handle ternary operator for showBackground', ()=>{
            ...
            const { unmount: unmount1 } = render(/*#__PURE__*/ _jsx(LogLevelBadge, {
                level: "INFO",
                showBackground: true
            }));
            ...
            const { unmount: unmount2 } = render(/*#__PURE__*/ _jsx(LogLevelBadge, {
                level: "INFO",
                showBackground: false
            }));
        ...
        it('should handle isValidLogLevel check for all levels', ()=>{
            ...
            for (const level of levels){
                const { unmount } = render(/*#__PURE__*/ _jsx(LogLevelBadge, {
                    level: level
                }));
        ...
        it('should handle all valid log levels with background', ()=>{
            ...
            for (const level of validLevels){
                const { unmount, container } = render(/*#__PURE__*/ _jsx(LogLevelBadge, {
                    level: level,
                    showBackground: true
                }));
                const badge = container.firstChild;
