...
export const WorkflowModalOverlay = styled.div`
  position: fixed;
  inset: 0;
  z-index: 50;
  display: flex;
...
export const WorkflowModalForm = styled.form`
  background: ${c.white};
...
export const WorkflowModalHeader = styled.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
`;

export const WorkflowModalTitle = styled.h3`
  margin: 0;
  font-size: 1.125rem;
  font-weight: 600;
  color: ${c.gray900};
...
export const WorkflowModalClose = styled.button`
  padding: 0;
  border: none;
  background: transparent;
  color: ${c.gray500};
...
export const WorkflowFieldLabel = styled.label`
  display: block;
  font-size: 0.875rem;
  font-weight: 500;
  color: ${c.gray700};
...
export const WorkflowFieldInput = styled.input`
  width: 100%;
  padding: 0.5rem 0.75rem;
...
export const WorkflowFieldSelect = styled.select`
  width: 100%;
  padding: 0.5rem 0.75rem;
  border: 1px solid ${c.gray300};
  border-radius: 0.5rem;
...
export const WorkflowModalRow = styled.div`
  display: flex;
  gap: 1rem;
`;

export const WorkflowModalCol = styled.div`
  flex: 1;
`;
...
export const WorkflowModalSecondary = styled.button`
  padding: 0.5rem 1rem;
  border: 1px solid ${c.gray300};
  border-radius: 0.5rem;
  background: ${c.white};
...
export const WorkflowModalSubmit = styled.button`
  display: inline-flex;
  align-items: center;
  gap: 0.5rem;
  padding: 0.5rem 1rem;
