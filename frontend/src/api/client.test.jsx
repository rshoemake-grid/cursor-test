...
describe("createApiClient", () => {
  ...
  describe("Workflows", () => {
    it("should get all workflows", async () => {
      ...
      mockInstance.get.mockResolvedValue({ data: workflows });
    ...
    it("should get workflow by id", async () => {
      ...
      mockInstance.get.mockResolvedValue({ data: workflow });
      const api = createApiClient();
    ...
    it("should create workflow", async () => {
      ...
      mockInstance.post.mockResolvedValue({ data: createdWorkflow });
      const api = createApiClient();
    ...
    it("should update workflow", async () => {
      ...
      mockInstance.put.mockResolvedValue({ data: updatedWorkflow });
      const api = createApiClient();
    ...
    it("should bulk delete workflows", async () => {
      ...
      mockInstance.post.mockResolvedValue({ data: response });
      const api = createApiClient();
    ...
    it("should duplicate workflow", async () => {
      ...
      mockInstance.get.mockResolvedValue({ data: originalWorkflow });
      mockInstance.post.mockResolvedValue({ data: duplicatedWorkflow });
      const api = createApiClient();
  ...
  describe("Executions", () => {
    it("should execute workflow", async () => {
      ...
      mockInstance.post.mockResolvedValue({ data: executionState });
      const api = createApiClient();
    ...
    it("should get execution by id", async () => {
      ...
      mockInstance.get.mockResolvedValue({ data: executionState });
      const api = createApiClient();
    ...
    it("should list executions", async () => {
      ...
      mockInstance.get.mockResolvedValue({ data: executions });
      const api = createApiClient();
      const result = await api.listExecutions();
      expect(mockInstance.get).toHaveBeenCalledWith("/executions", { params: void 0 });
    ...
    it("should get execution logs", async () => {
      ...
      mockInstance.get.mockResolvedValue({ data: logsResponse });
      const api = createApiClient();
      const result = await api.getExecutionLogs("exec-1");
      expect(mockInstance.get).toHaveBeenCalledWith("/executions/exec-1/logs", { params: void 0 });
  ...
  describe("Custom options", () => {
    ...
    it("should use custom logger", async () => {
      ...
      const api = createApiClient({ logger: customLogger });
  ...
  describe("Request interceptor", () => {
    ...
    it("should handle rememberMe being undefined", () => {
      mockLocalStorage.getItem.mockImplementation((key) => {
        if (key === "auth_remember_me") return null;
        if (key === "auth_token") return "token-from-local";
        return null;
      });
      mockSessionStorage.getItem.mockImplementation((key) => {
    ...
    it("should handle interceptor when rememberMe is empty string", () => {
      mockLocalStorage.getItem.mockImplementation((key) => {
        if (key === "auth_remember_me") return "";
        if (key === "auth_token") return "token-from-local";
        return null;
      });
      mockSessionStorage.getItem.mockImplementation((key) => {
