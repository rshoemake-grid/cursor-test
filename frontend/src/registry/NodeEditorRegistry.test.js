import { nodeEditorRegistry } from './NodeEditorRegistry';
describe('NodeEditorRegistry', ()=>{
    ...
    describe('register', ()=>{
        ...
        it('should overwrite existing handler and warn', ()=>{
            ...
            expect(consoleSpy).toHaveBeenCalledWith('[WARN]', expect.stringContaining('Node type "test-node" is already registered. Overwriting.'));
