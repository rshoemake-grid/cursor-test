...
describe("validationHelpers utilities", () => {
  ...
  describe("anyTruthy", () => {
    it("should return true when any value is truthy", () => {
      expect(anyTruthy(null, void 0, "test")).toBe(true);
    });
    it("should return false when all values are falsy", () => {
      expect(anyTruthy(null, void 0, "", 0, false)).toBe(false);
    });
  ...
  describe("hasArrayItems", () => {
    ...
    it("should return false for undefined", () => {
      expect(hasArrayItems(void 0)).toBe(false);
    });
    it("should return false for empty array", () => {
    ...
    it("should return false for non-array", () => {
      expect(hasArrayItems({})).toBe(false);
      expect(hasArrayItems("string")).toBe(false);
    });
  ...
  describe("isValidObject", () => {
    ...
    it("should return false for undefined", () => {
      expect(isValidObject(void 0)).toBe(false);
    });
  ...
  describe("isValidNumber", () => {
    ...
    it("should return false for undefined", () => {
      expect(isValidNumber(void 0)).toBe(false);
    });
