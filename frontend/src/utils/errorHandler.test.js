...
describe('errorHandler', ()=>{
    ...
    describe('handleStorageError', ()=>{
        it('should log storage errors', ()=>{
            ...
            expect(logger.error).toHaveBeenCalledWith('[Storage Error Handler] Storage setItem error for key "test-key":', error);
        });
        it('should include context in log messages', ()=>{
            ...
            expect(logger.error).toHaveBeenCalledWith('[WorkflowChat] Storage getItem error for key "key":', error);
        });
    ...
    describe('handleError', ()=>{
        ...
        it('should handle handleError with number error', ()=>{
            const message = handleError(123, {
                defaultMessage: 'Default'
            });
            expect(message).toBe('Default');
        });
        it('should handle handleError with boolean error', ()=>{
            const message = handleError(true, {
                defaultMessage: 'Default'
            });
            expect(message).toBe('Default');
        });
