 ...
 */ export function coalesceObject(value, defaultValue) {
    // Explicit checks kill mutations
 ...
 */ export function coalesceArray(value, defaultValue) {
    // Explicit checks kill mutations
 ...
 */ export function coalesceString(value, defaultValue) {
    // Explicit checks kill mutations
 ...
 */ export function coalesceChain(...values) {
    // Explicit checks kill mutations
 ...
 */ export function coalesceChainWithDefault(defaultValue, ...values) {
    // Explicit checks kill mutations
    for (const value of values){
        if (value !== null && value !== undefined) {
            return value;
 ...
 */ export function coalesceObjectChain(defaultValue, ...values) {
    // Explicit checks kill mutations
    for (const value of values){
 ...
 */ export function coalesceArrayChain(defaultValue, ...values) {
    // Explicit checks kill mutations
    for (const value of values){
        if (value !== null && value !== undefined && Array.isArray(value)) {
            return value;
 ...
 */ export function coalesceStringChain(defaultValue, ...values) {
    // Explicit checks kill mutations
    for (const value of values){
        if (value !== null && value !== undefined && typeof value === 'string' && value !== '') {
            return value;
