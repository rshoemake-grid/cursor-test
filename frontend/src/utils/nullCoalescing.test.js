 ...
 */ import { coalesce, coalesceObject, coalesceArray, coalesceString, coalesceChain, coalesceChainWithDefault, coalesceObjectChain, coalesceArrayChain, coalesceStringChain } from './nullCoalescing';
describe('nullCoalescing utilities', ()=>{
    ...
    describe('coalesceObjectChain', ()=>{
        ...
        it('should return default when all values are invalid', ()=>{
            expect(coalesceObjectChain({}, null, undefined, [], 'string')).toEqual({});
        });
    });
    describe('coalesceArrayChain', ()=>{
        ...
        it('should return default when all values are invalid', ()=>{
            expect(coalesceArrayChain([], null, undefined, {}, 'string')).toEqual([]);
        });
    });
