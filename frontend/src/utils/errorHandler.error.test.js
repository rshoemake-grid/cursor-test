...
describe('errorHandler - Error Guards', ()=>{
    ...
    describe('handleApiError - null/undefined guards', ()=>{
        ...
        it('should log error with context', ()=>{
            ...
            expect(mockLoggerError).toHaveBeenCalledWith('[TestContext] API Error:', expect.any(Error));
        });
    ...
    describe('handleStorageError - error object guards', ()=>{
        it('should handle null error object', ()=>{
            handleStorageError(null, 'getItem', 'key');
            expect(mockLoggerError).toHaveBeenCalled();
        });
        it('should handle undefined error object', ()=>{
            handleStorageError(undefined, 'getItem', 'key');
            expect(mockLoggerError).toHaveBeenCalled();
        });
        it('should handle error without message property', ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith('Failed to setItem storage: Unknown error');
        });
        it('should handle Error instance', ()=>{
            const error = new Error('Storage error');
            handleStorageError(error, 'getItem', 'key');
            expect(mockLoggerError).toHaveBeenCalledWith('[Storage Error Handler] Storage getItem error for key "key":', error);
        });
        it('should handle error with message property', ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith('Failed to setItem storage: Quota exceeded');
        });
        it('should handle error.message as null', ()=>{
            const error = {
                message: null
            ...
            expect(mockShowError).toHaveBeenCalledWith('Failed to removeItem storage: Unknown error');
        });
        it('should handle error.message as undefined', ()=>{
            ...
            expect(mockShowError).toHaveBeenCalledWith('Failed to clear storage: Unknown error');
        });
        it('should log with context when provided', ()=>{
            ...
            expect(mockLoggerError).toHaveBeenCalledWith('[TestContext] Storage getItem error for key "key":', error);
        });
    });
    describe('handleError - type guards', ()=>{
        ...
        it('should log with context when provided', ()=>{
            ...
            expect(mockLoggerError).toHaveBeenCalledWith('[TestContext] Error:', error);
        });
        it('should show notification when requested', ()=>{
