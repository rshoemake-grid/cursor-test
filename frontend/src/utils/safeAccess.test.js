 ...
 */ import { safeGet, safeGetProperty, safeCall, safeGetArrayElement } from './safeAccess';
describe('safeAccess utilities', ()=>{
    ...
    describe('safeGetProperty', ()=>{
        ...
        it('should return value when property exists', ()=>{
            expect(safeGetProperty({
                prop: 'value'
            }, 'prop', 'default')).toBe('value');
        });
    ...
    describe('safeGetArrayElement', ()=>{
        ...
        it('should return default when not an array', ()=>{
            expect(safeGetArrayElement({}, 0, 'default')).toBe('default');
        });
        it('should return value when index exists', ()=>{
            expect(safeGetArrayElement([
                'a',
                'b',
                'c'
            ], 1, 'default')).toBe('b');
