 ...
 */ import { safeStorageGet, safeStorageSet, safeStorageRemove, safeStorageHas, safeStorageClear } from './storageHelpers';
...
describe('storageHelpers - Mutation Killers', ()=>{
    ...
    describe('safeStorageGet - exact conditionals', ()=>{
        ...
        it('should verify exact falsy check - storage is undefined', ()=>{
            const result = safeStorageGet(undefined, 'key', 'default');
            expect(result).toBe('default');
        });
    ...
    describe('safeStorageSet - exact conditionals and ternary', ()=>{
        ...
        it('should verify exact falsy check - storage is undefined', ()=>{
            const result = safeStorageSet(undefined, 'key', 'value');
            expect(result).toBe(false);
        });
    ...
    describe('safeStorageRemove - exact falsy check', ()=>{
        ...
        it('should verify exact falsy check - storage is undefined', ()=>{
            const result = safeStorageRemove(undefined, 'key');
            expect(result).toBe(false);
        });
    ...
    describe('safeStorageHas - exact falsy check and logical AND', ()=>{
        ...
        it('should verify exact falsy check - storage is undefined', ()=>{
            const result = safeStorageHas(undefined, 'key');
            expect(result).toBe(false);
        });
    ...
    describe('safeStorageClear - exact falsy check and logical OR', ()=>{
        ...
        it('should verify exact falsy check - storage is undefined', ()=>{
            const result = safeStorageClear(undefined);
            expect(result).toBe(false);
        });
    ...
    describe('Error handling - exact method calls', ()=>{
        ...
        it('should verify exact method call - JSON.stringify in safeStorageSet', ()=>{
            safeStorageSet(mockStorage, 'key', {
                value: 'test'
            });
            expect(mockStorage.setItem).toHaveBeenCalledWith('key', JSON.stringify({
                value: 'test'
            }));
        });
    ...
    describe('Context parameter - exact property access', ()=>{
        it('should verify context is passed to error handler in safeStorageGet', ()=>{
            ...
            expect(handleStorageError).toHaveBeenCalledWith(expect.any(Error), 'getItem', 'key', expect.objectContaining({
                context: 'TestContext'
            }));
        ...
        it('should verify context is passed to error handler in safeStorageSet', ()=>{
            ...
            expect(handleStorageError).toHaveBeenCalledWith(expect.any(Error), 'setItem', 'key', expect.objectContaining({
                context: 'TestContext'
            }));
        ...
        it('should verify context is passed to error handler in safeStorageRemove', ()=>{
            ...
            expect(handleStorageError).toHaveBeenCalledWith(expect.any(Error), 'removeItem', 'key', expect.objectContaining({
                context: 'TestContext'
            }));
            // Verify exact context property access
            const callArgs = handleStorageError.mock.calls[0];
        ...
        it('should verify context is passed to error handler in safeStorageClear', ()=>{
            ...
            expect(handleStorageError).toHaveBeenCalledWith(expect.any(Error), 'clear', 'all', expect.objectContaining({
                context: 'TestContext'
            }));
            // Verify exact context property access
            const callArgs = handleStorageError.mock.calls[0];
