 ...
 */ export function safeStorageGet(storage, key, defaultValue, context) {
    return withStorageErrorHandling(storage, (storage)=>{
    ...
    }, 'getItem', key, defaultValue, context);
}
/**
 ...
 */ export function safeStorageSet(storage, key, value, context) {
    return withStorageErrorHandling(storage, (storage)=>{
        ...
        return true;
    }, 'setItem', key, false, context);
}
/**
 * Safe storage remove operation with error handling
 * Follows DRY principle by using error handling wrapper
 */ export function safeStorageRemove(storage, key, context) {
    return withStorageErrorHandling(storage, (storage)=>{
        storage.removeItem(key);
        return true;
    }, 'removeItem', key, false, context);
}
/**
 * Check if a storage key exists
 * Follows DRY principle by using error handling wrapper
 */ export function safeStorageHas(storage, key, context) {
    return withStorageErrorHandling(storage, (storage)=>{
        const item = storage.getItem(key);
        return isDefined(item) === true;
    }, 'getItem', key, false, context);
}
/**
 ...
 * Follows DRY principle by using error handling wrapper
 */ export function safeStorageClear(storage, context) {
    return withStorageErrorHandling(storage, (storage)=>{
