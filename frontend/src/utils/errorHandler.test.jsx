...
describe("errorHandler", () => {
  ...
  describe("handleError", () => {
    ...
    it("should handle handleError with null error", () => {
      const message = handleError(null, { defaultMessage: "Default" });
      expect(message).toBe("Default");
    });
    it("should handle handleError with number error", () => {
      const message = handleError(123, { defaultMessage: "Default" });
      expect(message).toBe("Default");
    });
    it("should handle handleError with boolean error", () => {
      const message = handleError(true, { defaultMessage: "Default" });
      expect(message).toBe("Default");
    });
    ...
    it("should handle undefined error.response", () => {
      const error = { response: void 0, message: "Network error" };
      const message = handleApiError(error);
      expect(message).toBe("Network error");
    });
    ...
    it("should handle undefined error.response.data", () => {
      const error = { response: { data: void 0 }, message: "Network error" };
      const message = handleApiError(error);
      expect(message).toBe("Network error");
    });
