 ...
 */ import { isNotNullOrUndefined, hasSize, hasMultipleSelected, isExplicitlyFalse, safeArray, isNonEmptyArray, isNotEmpty, hasItems, getOrDefault } from './nullChecks';
describe('nullChecks utilities', ()=>{
    ...
    describe('hasMultipleSelected', ()=>{
        ...
        it('should return false when one or zero items selected', ()=>{
            expect(hasMultipleSelected(new Set([
                'a'
            ]))).toBe(false);
