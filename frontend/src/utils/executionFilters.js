 ...
 */ export function filterByStatus(executions, statuses) {
 ...
 */ export function filterByWorkflowId(executions, workflowId) {
    if (!workflowId) {
        return executions;
    }
 ...
 */ export function filterBySearchQuery(executions, searchQuery) {
...
/**
 * Sort executions
 */ export function sortExecutions(executions, sortBy = 'started_at', sortOrder = 'desc') {
    const sorted = [
        ...executions
    ].sort((a, b)=>{
        let comparison = 0;
 ...
 */ export function applyExecutionFilters(executions, filters) {
