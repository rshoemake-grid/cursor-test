 ...
 */ import { convertEdgesToWorkflowFormat, convertNodesToWorkflowFormat, createWorkflowDefinition, initializeReactFlowNodes, formatEdgesForReactFlow, normalizeNodeForStorage, workflowNodeToReactFlowNode } from './workflowFormat';
describe('workflowFormat utilities', ()=>{
    ...
    describe('convertNodesToWorkflowFormat', ()=>{
        ...
        it('should handle nodes with all config types', ()=>{
            ...
            const result = convertNodesToWorkflowFormat(nodes);
            expect(result[0].agent_config).toEqual({
                model: 'gpt-4'
            });
            expect(result[0].condition_config).toEqual({
                condition_type: 'equals'
            });
            expect(result[0].loop_config).toEqual({
                loop_type: 'for_each'
            });
            expect(result[0].input_config).toEqual({
                mode: 'read'
            });
    ...
    describe('workflowNodeToReactFlowNode', ()=>{
        ...
        it('should verify sourceHandle || source_handle || null fallback chain', ()=>{
            ...
            const result1 = formatEdgesForReactFlow([
                edge1
            ]);
            ...
            const result2 = formatEdgesForReactFlow([
                edge2
            ]);
            ...
            const result3 = formatEdgesForReactFlow([
                edge3
            ]);
    ...
    describe('additional coverage for no-coverage mutants', ()=>{
        describe('exact type checks', ()=>{
            it('should verify exact typeof edge.label === string comparison', ()=>{
                ...
                const result1 = convertEdgesToWorkflowFormat([
                    edge1
                ]);
                ...
                const result2 = convertEdgesToWorkflowFormat([
                    edge2
                ]);
                ...
                const result3 = convertEdgesToWorkflowFormat([
                    edge3
                ]);
            ...
            it('should verify exact typeof node.data.name === string comparison', ()=>{
                ...
                const result1 = convertNodesToWorkflowFormat([
                    node1
                ]);
                ...
                const result2 = convertNodesToWorkflowFormat([
                    node2
                ]);
            ...
            it('should verify exact Array.isArray(node.data.inputs) comparison', ()=>{
                ...
                expect(result1[0].inputs).toEqual([
                    {
                        name: 'input1'
                    }
                ]);
        ...
        describe('exact logical OR operators', ()=>{
            it('should verify exact logical OR node.data.name || node.data.label || node.id', ()=>{
                ...
                const result3 = convertNodesToWorkflowFormat([
                    node3
                ]);
            ...
            it('should verify exact logical OR node.data.agent_config || {}', ()=>{
                ...
                const result1 = initializeReactFlowNodes([
                    node1
                ]);
                expect(result1[0].data.agent_config).toEqual({
                    model: 'gpt-4'
                });
                ...
                const result2 = initializeReactFlowNodes([
                    node2
                ]);
        ...
        describe('exact nullish coalescing operators', ()=>{
            ...
            it('should verify exact nullish coalescing (node.data as any)?.agent_config ?? (node as any).agent_config ?? {}', ()=>{
                ...
                expect(result1.data.agent_config).toEqual({
                    model: 'gpt-4'
                });
                ...
                expect(result2.data.agent_config).toEqual({
                    model: 'gpt-3.5'
                });
        ...
        describe('exact string comparisons', ()=>{
            it('should verify exact string comparison key !== sourceHandle', ()=>{
                ...
                const result = formatEdgesForReactFlow([
                    edge
                ]);
