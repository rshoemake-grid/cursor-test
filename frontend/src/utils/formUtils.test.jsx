...
describe("formUtils", () => {
  describe("getNestedValue", () => {
    ...
    it("should handle undefined object", () => {
      expect(getNestedValue(void 0, "user.name", "default")).toBe("default");
      expect(getNestedValue(void 0, "user.name")).toBeUndefined();
    });
  ...
  describe("setNestedValue", () => {
    ...
    it("should handle undefined values", () => {
      const obj = { user: { name: "John" } };
      const result = setNestedValue(obj, "user.name", void 0);
  ...
  describe("hasNestedValue", () => {
    ...
    it("should return false for undefined object", () => {
      expect(hasNestedValue(void 0, "user.name")).toBe(false);
    });
    ...
    it("should return true for undefined value", () => {
      const obj = { user: { name: void 0 } };
      expect(hasNestedValue(obj, "user.name")).toBe(true);
    });
