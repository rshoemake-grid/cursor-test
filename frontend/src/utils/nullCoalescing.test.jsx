...
describe("nullCoalescing utilities", () => {
  ...
  describe("coalesceArray", () => {
    ...
    it("should return default when value is undefined", () => {
      expect(coalesceArray(void 0, [])).toEqual([]);
    });
    it("should return default when value is object", () => {
      expect(coalesceArray({}, [])).toEqual([]);
    });
  ...
  describe("coalesceString", () => {
    ...
    it("should return default when value is undefined", () => {
      expect(coalesceString(void 0, "default")).toBe("default");
    });
    ...
    it("should return default when value is not a string", () => {
      expect(coalesceString(123, "default")).toBe("default");
    });
  });
  describe("coalesceChain", () => {
    it("should return first non-null value", () => {
      expect(coalesceChain(null, void 0, "test", "other")).toBe("test");
    });
    it("should return null when all values are null/undefined", () => {
      expect(coalesceChain(null, void 0, null)).toBeNull();
    });
    it("should handle zero as valid value", () => {
  ...
  describe("coalesceObjectChain", () => {
    it("should return first valid object", () => {
      const obj1 = { a: 1 };
      const obj2 = { b: 2 };
      expect(coalesceObjectChain({}, null, void 0, obj1, obj2)).toBe(obj1);
    });
    it("should return default when all values are invalid", () => {
      expect(coalesceObjectChain({}, null, void 0, [], "string")).toEqual({});
    });
  });
  describe("coalesceArrayChain", () => {
    it("should return first valid array", () => {
      const arr1 = [1, 2];
      const arr2 = [3, 4];
      expect(coalesceArrayChain([], null, void 0, arr1, arr2)).toBe(arr1);
    });
    it("should return default when all values are invalid", () => {
      expect(coalesceArrayChain([], null, void 0, {}, "string")).toEqual([]);
    });
  });
