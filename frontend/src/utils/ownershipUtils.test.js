 ...
 */ import { isOwner, filterOwnedItems, separateOfficialItems, filterUserOwnedDeletableItems } from './ownershipUtils';
describe('ownershipUtils', ()=>{
    describe('isOwner', ()=>{
        ...
        it('should return false when user is undefined', ()=>{
            expect(isOwner(mockItem, undefined)).toBe(false);
        });
        ...
        it('should return false when item is undefined', ()=>{
            expect(isOwner(undefined, mockUser)).toBe(false);
        });
    ...
    describe('filterOwnedItems', ()=>{
        ...
        it('should return empty array when user is undefined', ()=>{
            ...
            expect(filterOwnedItems(items, undefined)).toEqual([]);
        });
