 ...
 */ export function formatExecutionDuration(startedAt, completedAt) {
 ...
 */ export function getExecutionStatusIcon(status) {
    switch(status){
        case 'completed':
 ...
 */ export function sortExecutionsByStartTime(executions) {
    return [
        ...executions
    ].sort((a, b)=>{
 ...
 */ export function calculateExecutionProgress(nodeStates) {
    if (!nodeStates) {
        return 0;
    }
