 ...
 */ import { formatExecutionDuration, getExecutionStatusIcon, sortExecutionsByStartTime, calculateExecutionProgress } from './executionFormat';
...
describe('executionFormat utilities', ()=>{
    ...
    describe('getExecutionStatusIcon', ()=>{
        it('should return CheckCircle for completed status', ()=>{
            ...
            const { container } = render(/*#__PURE__*/ _jsx(_Fragment, {
                children: icon
            }));
