 ...
 */ export const DEFAULT_UNEXPECTED_ERROR_MESSAGE = 'An unexpected error occurred';
/**
 * Error context prefix for error handler logs
 */ export const ERROR_CONTEXT_PREFIX = '[Error Handler]';
/**
 * Error context prefix for storage error handler logs
 */ export const STORAGE_ERROR_PREFIX = '[Storage Error Handler]';
/**
 * Template for storage operation error messages
 * @param operation - The storage operation that failed
 * @param errorMsg - The error message
 * @returns Formatted error message
 */ export function formatStorageErrorMessage(operation, errorMsg) {
