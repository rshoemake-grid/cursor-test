  ...
  describe("runtime validation functions", () => {
    describe("hasWorkflowBuilderCoreProps", () => {
      ...
      it("should reject invalid objects", () => {
        ...
        expect(hasWorkflowBuilderCoreProps(void 0)).toBe(false);
    ...
    describe("hasWorkflowBuilderExecutionProps", () => {
      ...
      it("should reject non-objects", () => {
        ...
        expect(hasWorkflowBuilderExecutionProps(void 0)).toBe(false);
    ...
    describe("hasWorkflowBuilderPersistenceProps", () => {
      ...
      it("should reject non-objects", () => {
        ...
        expect(hasWorkflowBuilderPersistenceProps(void 0)).toBe(false);
      });
    });
    describe("hasWorkflowBuilderDependencyProps", () => {
      ...
      it("should reject non-objects", () => {
        ...
        expect(hasWorkflowBuilderDependencyProps(void 0)).toBe(false);
      });
    });
