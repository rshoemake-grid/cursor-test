...
describe('ResetPasswordPage', ()=>{
    ...
    it('should render reset password page', async ()=>{
        renderWithRouter(/*#__PURE__*/ _jsx(ResetPasswordPage, {}));
    ...
    it('should toggle password visibility', async ()=>{
        ...
        const toggleButtons = screen.getAllByRole('button').filter((btn)=>btn.getAttribute('type') === 'button' && btn.querySelector('svg'));
    ...
    describe('Dependency Injection', ()=>{
        it('should use injected HTTP client', async ()=>{
            ...
            fireEvent.click(submitButton);
            await waitForWithTimeout(()=>{
                expect(mockHttpClient.post).toHaveBeenCalledWith(expect.stringContaining('/auth/reset-password'), expect.objectContaining({
                    token: 'test-token',
                    new_password: 'newpassword123'
                }), expect.any(Object));
            });
        ...
        it('should use injected API base URL', async ()=>{
            ...
            fireEvent.click(submitButton);
            await waitForWithTimeout(()=>{
                expect(mockHttpClient.post).toHaveBeenCalledWith('https://custom-api.example.com/api/auth/reset-password', expect.any(Object), expect.any(Object));
            });
        });
