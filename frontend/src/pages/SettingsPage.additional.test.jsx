...
describe('SettingsPage - Additional Coverage', ()=>{
    ...
    describe('Provider Management', ()=>{
        it('should handle adding provider from template', async ()=>{
            ...
            renderWithRouter(/*#__PURE__*/ _jsx(SettingsPage, {}));
    ...
    describe('Auto-save', ()=>{
        ...
        it('should enable auto-save when authenticated and settings loaded', async ()=>{
            ...
            await waitFor(()=>{
                ...
                const enabledCalls = mockUseAutoSave.mock.calls.filter((call)=>call.length > 3 && call[3] === true);
        ...
        it('should disable auto-save when not authenticated', async ()=>{
            ...
            await waitFor(()=>{
                ...
                const autoSaveCall = mockUseAutoSave.mock.calls.find((call)=>call.length > 3 && call[3] === false);
