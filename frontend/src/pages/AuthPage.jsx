...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-blue-100", children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-2", children: isLogin ? "Welcome Back" : "Create Account" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: isLogin ? "Sign in to your workflow account" : "Start building amazing workflows" })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      ...
      !isLogin && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Full Name (optional)" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
      ...
      isLogin && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          ...
          /* @__PURE__ */ jsx("label", { htmlFor: "rememberMe", className: "ml-2 block text-sm text-gray-700", children: "Keep me logged in" })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
