...
export default function LogPage({ apiClient: injectedApiClient } = {}) {
    ...
    const finalFilteredExecutions = useMemo(()=>{
        ...
        advancedFilteredExecutions,
        searchQuery
    ]);
    // Pagination
    const { currentPage, totalPages, paginatedExecutions, setCurrentPage, setItemsPerPage, itemsPerPage, totalItems } = useExecutionPagination({
    ...
    const handleBulkDelete = async (executionIds)=>{
        const confirmed = await showConfirm(`Are you sure you want to delete ${executionIds.length} execution(s)? This action cannot be undone.`, {
    ...
    useExecutionNotifications({
        ...
        onError: (execution)=>{
            toast.error(`Execution ${execution.execution_id.slice(0, 8)}... failed${execution.error ? `: ${execution.error}` : ''}`);
        },
        enabled: !bulkMode
    });
    if (loading) {
    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            ...
            /*#__PURE__*/ _jsx(ExecutionDetailsModal, {
                    ...
                    children: [
                        /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [
                                ...
                                finalFilteredExecutions.length > 0 && /*#__PURE__*/ _jsxs("div", {
                        ...
                        bulkMode && /*#__PURE__*/ _jsx(BulkActionsBar, {
                        ...
                        /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [
                                ...
                                showAdvancedFilters && /*#__PURE__*/ _jsx("div", {
                                    className: "mt-4",
                                    children: /*#__PURE__*/ _jsx(AdvancedFiltersPanel, {
                                        filters: advancedFilters,
                                        onFiltersChange: setAdvancedFilters,
                                        onClose: ()=>setShowAdvancedFilters(false)
                                    })
                                }),
                                filterCount > 0 && /*#__PURE__*/ _jsxs("div", {
                        ...
                        /*#__PURE__*/ _jsx(ExecutionFilters, {
                            filters: filters,
                        ...
                        finalFilteredExecutions.length === 0 ? /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ _jsx("p", {
                                    ...
                                    children: "Execute a workflow to see execution logs here"
                                })
                            ]
                                    ...
                                    children: [
                                        bulkMode && /*#__PURE__*/ _jsxs("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ _jsx("span", {
                                                    className: "text-sm text-gray-600",
                                                    children: bulkOperations.isAllSelected ? 'Deselect all' : 'Select all'
                                                })
                                            ]
                                        }),
                                        paginatedExecutions.length > 50 ? /*#__PURE__*/ _jsx(VirtualizedList, {
                                            items: paginatedExecutions,
                                            itemHeight: 120,
                                            containerHeight: 600,
                                            renderItem: (execution)=>/*#__PURE__*/ _jsx("div", {
                                                    className: "mb-3",
                                                    children: /*#__PURE__*/ _jsx(ExecutionListItem, {
                                                        execution: execution,
                                        ...
                                        }) : paginatedExecutions.map((execution)=>/*#__PURE__*/ _jsx(ExecutionListItem, {
                                                execution: execution,
                                                onExecutionClick: handleExecutionClick,
                                                isSelected: bulkOperations.selectedIds.has(execution.execution_id),
                                                onSelect: bulkOperations.toggleSelection,
