...
export default function ResetPasswordPage({ httpClient = defaultAdapters.createHttpClient(), apiBaseUrl = API_CONFIG.BASE_URL } = {}) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await httpClient.post(`${apiBaseUrl}${API_CONFIG.ENDPOINTS.AUTH.RESET_PASSWORD}`, {
                token,
                ...
                children: /*#__PURE__*/ _jsxs("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsx("p", {
                            ...
                            children: "Your password has been reset. Redirecting to login..."
                        })
                    ]
                })
            })
                                ...
                                /*#__PURE__*/ _jsxs("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ _jsx("button", {
                                            ...
                                            className: "absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none",
                                            tabIndex: -1,
                                            children: showConfirmPassword ? /*#__PURE__*/ _jsx(EyeOff, {
                                                className: "w-5 h-5"
                                            }) : /*#__PURE__*/ _jsx(Eye, {
                                                className: "w-5 h-5"
                                            })
