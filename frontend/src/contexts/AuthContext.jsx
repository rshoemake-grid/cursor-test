...
const AuthProvider = ({ children, options }) => {
  const local = useMemo(() => options?.localStorage !== void 0 ? options.localStorage : defaultAdapters.createLocalStorageAdapter(), [options?.localStorage]);
  const session = useMemo(() => options?.sessionStorage !== void 0 ? options.sessionStorage : defaultAdapters.createSessionStorageAdapter(), [options?.sessionStorage]);
