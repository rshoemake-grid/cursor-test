...
describe("AuthProvider", () => {
  ...
  const wrapper = ({ children, options }) => /* @__PURE__ */ jsx(AuthProvider, { options, children });
  ...
  describe("Custom options", () => {
    ...
    it("should use custom logger", async () => {
      ...
      const { result } = renderHook(() => useAuth(), {
        wrapper: ({ children }) => wrapper({ children, options: { localStorage: mockLocalStorage, sessionStorage: mockSessionStorage, httpClient: customHttpClient, logger: customLogger } })
      });
      await expect(
        act(async () => {
          await result.current.login("testuser", "wrongpassword");
