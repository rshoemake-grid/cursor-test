...
describe('AuthProvider', ()=>{
    ...
    const wrapper = ({ children, options })=>/*#__PURE__*/ _jsx(AuthProvider, {
            options: options,
            children: children
        });
    ...
    describe('register', ()=>{
        it('should register successfully and auto-login', async ()=>{
            ...
            mockHttpClient.post.mockResolvedValueOnce(registerResponse).mockResolvedValueOnce(loginResponse);
            const { result } = renderHook(()=>useAuth(), {
                wrapper: ({ children })=>wrapper({
                        children,
                        options: {
    ...
    describe('Custom options', ()=>{
        it('should use custom apiBaseUrl', async ()=>{
            ...
            expect(customHttpClient.post).toHaveBeenCalledWith('https://custom.api.com/api/auth/login', expect.any(Object), expect.any(Object));
        });
        ...
        it('should handle register with fullName', async ()=>{
            ...
            expect(mockHttpClient.post).toHaveBeenCalledWith(expect.stringContaining('/auth/register'), expect.objectContaining({
                full_name: 'Full Name'
            }), expect.any(Object));
        });
